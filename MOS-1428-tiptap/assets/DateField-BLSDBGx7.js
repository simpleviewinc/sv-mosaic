...
| ---- | ---- | ----------- |\r
| `,t.jsx(r.strong,{children:t.jsx(r.code,{children:"showTime"})})," | ",t.jsx(r.code,{children:"boolean"}),` | optional - When true a time field will appear next to the date field. |\r
| `,t.jsx(r.strong,{children:t.jsx(r.code,{children:"minDate"})})," | ",t.jsx(r.code,{children:"Date"}),` | optional - The minimum date that can be chosen using the datepicker or entered into the input. Defaults to 01/01/1900. If used in a form component, will automatically register a minimum date validator |\r
| `,t.jsx(r.strong,{children:t.jsx(r.code,{children:"maxDate"})})," | ",t.jsx(r.code,{children:"Date"})," | optional - The maximum date that can be chosen using the datepicker or entered into the input. If used in a form component, will automatically register a minimum date validator |"]}),`
