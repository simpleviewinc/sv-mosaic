...
`,e.jsxs(n.p,{children:["Invoking ",e.jsx(n.code,{children:"useForm"})," returns an object that implements the ",e.jsx(n.code,{children:"FormController"})," interface. The properties of the form controller should be spread into the ",e.jsx(n.code,{children:"Form"})," component."]}),`
`,e.jsx(n.h4,{id:"interface-formcontroller",children:"Interface: FormController"}),`
`,e.jsxs(n.p,{children:[`| Name | Type | Description |
| ---- | ---- | ----------- |
| `,e.jsx(n.code,{children:"state"})," | ",e.jsx(n.code,{children:"FormState"})," | Contains all of the form state. You can use this to perform side effects. ",e.jsx(n.code,{children:"state"}),` is described in more detail below. |
| `,e.jsx(n.code,{children:"methods"})," | ",e.jsx(n.code,{children:"FormMethods"})," | Contains all of the methods necessary for manipulating form state. ",e.jsx(n.code,{children:"methods"}),` is described in more detail below. |
| `,e.jsx(n.code,{children:"handleSubmit"})," | ",e.jsx(n.code,{children:"(onSuccess: OnSubmitSuccess, onError?: OnSubmitError) => () => Promise<void>"})," | ",e.jsx(n.code,{children:"handleSubmit"})," is a higher order function available on the form controller and should be used to wrap a callback to be invoked on a successful submission. ",e.jsx(n.code,{children:"handleSubmit"})," accepts an optional second callback to be invoked on an invalid submission. Both callbacks will be invoked with the form data as their first parameter. |"]}),`
...
`,e.jsxs(n.p,{children:[`| Name | Type | Description |
| ---- | ---- | ----------- |
| `,e.jsx(n.code,{children:"data"})," | ",e.jsx(n.code,{children:"MosaicObject<any>"}),` | Contains a key-value pair object of all of the fields by name and their value |
| `,e.jsx(n.code,{children:"errors"})," | ",e.jsx(n.code,{children:"MosaicObject<string>"}),` | A key-value pair object of fields by their name and the error for that field, if any |
| `,e.jsx(n.code,{children:"disabled"})," | ",e.jsx(n.code,{children:"boolean"}),` | Whether or not the form is currently enabled. The form is disabled whilst it is being submitted |
| `,e.jsx(n.code,{children:"touched"})," | ",e.jsx(n.code,{children:"MosaicObject<boolean>"}),` | A key-value pair object of fields by their name and whether or not they have been touched. Once the user changes the value of any given field, it becomes touched |
| `,e.jsx(n.code,{children:"submitWarning"})," | ",e.jsx(n.code,{children:"string"}),` | The reason that the form cannot currently be submitted |
| `,e.jsx(n.code,{children:"waits"})," | ",e.jsx(n.code,{children:"FormWait[]"}),` | An array of reasons that the form is waiting. A wait can be created by busy fields or the form itself. |
| `,e.jsx(n.code,{children:"loadingInitial"})," | ",e.jsx(n.code,{children:"boolean"})," | ",e.jsx(n.code,{children:"true"})," if the form is currently in the initial loading stage, which includes loading initial values. ",e.jsx(n.code,{children:"false"})," when it's finished. |"]}),`
...
`,e.jsxs(n.p,{children:[`| Name | Type | Description |
| ---- | ---- | ----------- |
| `,e.jsx(n.code,{children:"setFormValues"})," | ",e.jsx(n.code,{children:"(params: { values:  MosaicObject<any>; initial?: boolean }) => void"}),` | Set the form values using an object of key-value pairs. Optionally have the form use these as initial values. |
| `,e.jsx(n.code,{children:"setFieldValue"})," | ",e.jsx(n.code,{children:"(params: { name: string; value: unknown \\| ((current: unknown) => unknown); validate?: boolean; touched?: boolean; }) => void"})," | Set the value for a given field. ",e.jsx(n.code,{children:"value"}),` can be a callback which returns the new value whose parameter is the current field value. Optionally validate the value after it has been set. Optionally mark the field as touched. |
| `,e.jsx(n.code,{children:"disableForm"})," | ",e.jsx(n.code,{children:"(params: { disable?: boolean; }) => void"})," | Disables the form if ",e.jsx(n.code,{children:"disable"}),` is true and enables it if not. |
| `,e.jsx(n.code,{children:"addWait"})," | ",e.jsx(n.code,{children:"(params?: { name: string; message: string; disableForm: boolean; }) => { remove: () => void }"})," | Adds a wait to the form, preventing submission with a message as a reason for prevention. Optionally disables the form whilst waiting. Returns an object containing a ",e.jsx(n.code,{children:"remove"}),` method which, when invoked, will remove the added wait. |
| `,e.jsx(n.code,{children:"removeWait"})," | ",e.jsx(n.code,{children:"(params?: { names: string[]; }) => void"}),` | Removes waits by name |
| `,e.jsx(n.code,{children:"mountField"})," | ",e.jsx(n.code,{children:"(params: MountFieldParams) => MountFieldResult"})," | Mount a field. It is necessary to invoke this method for custom fields when their components are mounted. It returns an object containing an ",e.jsx(n.code,{children:"unmount"}),` function to be invoked when the component is unmounted. |
| `,e.jsx(n.code,{children:"addValidator"})," | ",e.jsx(n.code,{children:"(params: { name: string; validator: () => undefined \\| string }) => { remove: () => void }"})," | Add a validator for a given field. A good way for fields to register their own field-type based validator functions . Returns an object containing a ",e.jsx(n.code,{children:"remove"}),` method that, when invoked, will unregister the validator |
| `,e.jsx(n.code,{children:"reset"})," | ",e.jsx(n.code,{children:"() => void"}),` | Resets the form to it's initial state, including initial values |
| `,e.jsx(n.code,{children:"init"})," | ",e.jsx(n.code,{children:"(params: { fields: FieldDef[] }) => void"})," | Initialise the form with the given fields. Should be used internally by the ",e.jsx(n.code,{children:"Form"})," component only. |"]}),`
...
`,e.jsxs(n.p,{children:[`| Name | Required | Type | Description |
| ---- | -------- | ---- | ----------- |
| `,e.jsx(n.code,{children:"state"})," | ✅ | ",e.jsx(n.code,{children:"FormState"})," | Contains all of the form state. This is part of the result of ",e.jsx(n.code,{children:"useForm"})," and you should never have to provide this yourself, though you can use it to perform side effects. ",e.jsx(n.code,{children:"state"}),` is described in more detail below. |
| `,e.jsx(n.code,{children:"methods"})," | ✅ | ",e.jsx(n.code,{children:"FormMethods"})," | Contains all of the methods necessary for manipulating form state. This is part of the result of ",e.jsx(n.code,{children:"useForm"})," and you should never have to provide this yourself. ",e.jsx(n.code,{children:"methods"}),` is described in more detail below. |
| `,e.jsx(n.code,{children:"fields"})," | ✅ | ",e.jsx(n.code,{children:"FieldDef[]"})," | Array of field definitions containing their respective configuration (see ",e.jsx(n.a,{href:"#form-fields",children:"Form Fields"}),`) |
| `,e.jsx(n.code,{children:"title"})," | | ",e.jsx(n.code,{children:"string"}),` | The title of the form to be displayed in a large heading at the top |
| `,e.jsx(n.code,{children:"description"})," |  | ",e.jsx(n.code,{children:"string"}),` | The description of the form to be displayed in smaller text below the title |
| `,e.jsx(n.code,{children:"onBack"})," |  | ",e.jsx(n.code,{children:"(() => void)"}),` | Callback used to go back to the previous screen / element / drawer. When passed a left arrow will render to the left of the title. |
| `,e.jsx(n.code,{children:"backLabel"})," |  | ",e.jsx(n.code,{children:"string"})," | If ",e.jsx(n.code,{children:"onBack"})," has been provided, this will be the ",e.jsx(n.code,{children:"aria-label"}),` of the button that is rendered |
| `,e.jsx(n.code,{children:"sections"})," |  | ",e.jsx(n.code,{children:"SectionDef[]"})," | Object containing all the configuration for every section of the form, including the layout in which fields will render. When no sections get passed fields will render 1 per row (see ",e.jsx(n.a,{href:"#sectiondef",children:"SectionDef subsection"}),`). |
| `,e.jsx(n.code,{children:"dialogOpen"})," |  | ",e.jsx(n.code,{children:"boolean"}),` | When true, this flag will render a dialog with the message "You have unsaved changes. If you leave all your changes will be lost." This only works when the prop type = "drawer". |
| `,e.jsx(n.code,{children:"handleDialogClose"})," |  | ",e.jsx(n.code,{children:"boolean"}),` | Function that will get called when closing the dialog (see explanaition of the dialogOpen prop) |
| `,e.jsx(n.code,{children:"getFormValues"})," |  | ",e.jsx(n.code,{children:"() => Promise<MosaicObject<any>>"}),` | Function that should return an object representing the initial field values |
| `,e.jsx(n.code,{children:"buttons"})," |  | ",e.jsx(n.code,{children:"ButtonProps[]"}),` | Array of buttons that will be rendered at the top of the form, adjacent to the title (if one is provided). |
| `,e.jsx(n.code,{children:"scrollSpyThreshold"})," |  | ",e.jsx(n.code,{children:"number"}),` | The threshold at which the scroll spy should consider a section "active". Defaults to 0.15, meaning whenever the top of a section intersects the top 15% of the form's scrollable area. |
| `,e.jsx(n.code,{children:"fullHeight"})," |  | ",e.jsx(n.code,{children:"boolean"})," | Whether to have the form stretch to the full height of it's parent. (",e.jsx(n.code,{children:"height: 100%"}),`). Defaults to true. |
| `,e.jsx(n.code,{children:"spacing"})," |  | ",e.jsx(n.code,{children:'"normal"'})," or ",e.jsx(n.code,{children:'"compact"'})," | What spacing to use for the form. Defaults to ",e.jsx(n.code,{children:'"normal"'}),` |
| `,e.jsx(n.code,{children:"useSectionHash"})," |  | ",e.jsx(n.code,{children:"string"})," or ",e.jsx(n.code,{children:"false"})," | The string that should be used to prefix the section index in the URL hash when scrolling. Provide ",e.jsx(n.code,{children:"false"}),` to disable the URL hash mechanic entirely. |
| `,e.jsx(n.code,{children:"autoFocus"})," |  | ",e.jsx(n.code,{children:"boolean"})," | If true, once mounted, ",e.jsx(n.code,{children:"Form"})," will attempt to automatically focus the user's cursor on the first field but only the first field is one of the following field types: ",e.jsx(n.code,{children:"date"}),", ",e.jsx(n.code,{children:"dropdown"}),", ",e.jsx(n.code,{children:"numberTable"}),", ",e.jsx(n.code,{children:"phone"}),", ",e.jsx(n.code,{children:"text"}),", ",e.jsx(n.code,{children:"textEditor"}),", ",e.jsx(n.code,{children:"time"}),".. |"]}),`
...
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-ts",children:`import { Form, useForm, FieldDef } from "@simpleview/sv-mosaic";
...
`,e.jsxs(n.p,{children:[`| Name | Required | Type | Description |
| ---- | -------- | ---- | ----------- |
| `,e.jsx(n.strong,{children:e.jsx(n.code,{children:"title"})})," | | ",e.jsx(n.code,{children:"string"}),` | Text that helps users identify the section. This is also used when rendering tabs to scroll the user to the selected section. |
| `,e.jsx(n.strong,{children:e.jsx(n.code,{children:"description"})})," | | ",e.jsx(n.code,{children:"string"})," or ",e.jsx(n.code,{children:"JSX.Element"}),` | Additional text that allows users to understand the purpose or instructions of a section better. |
| `,e.jsx(n.strong,{children:e.jsx(n.code,{children:"fields"})})," | ✅ | ",e.jsx(n.code,{children:"string[][][]"}),` | Section's field structure as explained above. The outermost array contains rows, the first nested array contains columns and the innermost array contains field names |
| `,e.jsx(n.strong,{children:e.jsx(n.code,{children:"collapsed"})})," | | ",e.jsx(n.code,{children:"boolean"})," | Whether or not the section should be collapsed by default. Defaults to false. Only applicable if a ",e.jsx(n.code,{children:"title"}),` is provided for this section. |
| `,e.jsx(n.strong,{children:e.jsx(n.code,{children:"show"})})," | | ",e.jsx(n.a,{href:"#MosaicToggle-t-type",children:e.jsx(n.code,{children:"MosaicToggle"})})," | Whether or not to render the section. Show callbacks will be called with ",e.jsx(n.code,{children:"{data: formState.data}"})," |"]}),`
...
`,e.jsxs(n.p,{children:[`| Name | Required | Type | Description |
| ---- | -------- | ---- | ----------- |
| `,e.jsx(n.code,{children:"name"})," | ✅ | ",e.jsx(n.code,{children:"string"})," | Significant name related to the field. Names should be unique to each field within the same form. The name will be used as the field's ",e.jsx(n.code,{children:"id"}),` HTML attribute. |
| `,e.jsx(n.code,{children:"type"})," | ✅ | ",e.jsx(n.code,{children:"string \\| JSX.Element \\| () => JSX.Element"}),` | Depicts the type of field that will be rendered. A string value will be mapped to one of Mosaic's built-in field types, providing a function will render a custom field. |
| `,e.jsx(n.code,{children:"label"})," | | ",e.jsx(n.code,{children:"string"})," | Descriptive label for the field which will be rendered in a HTML ",e.jsx(n.code,{children:"label"}),` element before the field's input |
| `,e.jsx(n.code,{children:"required"})," | | ",e.jsx(n.code,{children:"boolean"})," | Whether or not this is a required field. This will render an asterisk to indicate the field is required, as well as automatically adding the ",e.jsx(n.code,{children:"required"}),` validator. |
| `,e.jsx(n.code,{children:"helperText"})," | | ",e.jsx(n.code,{children:"string \\| JSX.Element"}),` | Text that gives context to the user as what the field does. |
| `,e.jsx(n.code,{children:"instructionText"})," | | ",e.jsx(n.code,{children:"string"}),` | Instructions about how to fill the current field. Will be rendered to the right of the field or as a hoverable tooltip next to the field's label, depending on the space available. |
| `,e.jsx(n.code,{children:"disabled"})," | | ",e.jsx(n.code,{children:"MosaicToggle<FormState>"}),` | Whether or not the field is disabled. Callbacks will be invoked with the form's current state. |
| `,e.jsx(n.code,{children:"inputSettings"})," | | ",e.jsx(n.code,{children:"T"}),` | Please see individual field type documentation for more information on what properties can be provided. |
| `,e.jsx(n.code,{children:"size"})," | | ",e.jsx(n.code,{children:'"xs" \\| "sm" \\| "md" \\| "lg"'}),` or any valid CSS width | How wide the field should render. (xs = 100px, sm = 280px, md = 450px, lg = 620px). |
| `,e.jsx(n.code,{children:"className"})," | | ",e.jsx(n.code,{children:"string"}),` | A class name to be added to the field's containing element. |
| `,e.jsx(n.code,{children:"style"})," | | ",e.jsx(n.code,{children:'HTMLAttributes<HTMLElement>["style"]'}),` | Custom styles to be added to the field's containing element. |
| `,e.jsx(n.code,{children:"validators"})," | | ",e.jsx(n.code,{children:"(string \\| { fn: ValidatorFn; options: any } \\| ValidatorFn)[]"})," | Validators to be executed when an the applicable validation trigger occurs on this field or when an onSubmit occurs on the Form (see the ",e.jsx(n.a,{href:"#validators",children:"validators"}),` section for more information about default and custom validators). |
| `,e.jsx(n.code,{children:"validateOn"})," | | ",e.jsx(n.code,{children:'"onBlur" \\| "onChange" \\| "onBlurAmend" \\| "onBlurChange"'})," | When the field should be validated. ",e.jsx(n.code,{children:"onBlur"})," will validate the field when it loses focus. ",e.jsx(n.code,{children:"onChange"})," will validate when the value of the field changes. ",e.jsx(n.code,{children:"onBlurAmend"})," will validate the field when it loses focus, but clear any validation errors once it has been amended. ",e.jsx(n.code,{children:"onBlurChange"}),` will validate the field only when it loses focus but will also validate for every subsequent change after losing focus once. |
| `,e.jsx(n.code,{children:"validates"})," | | ",e.jsx(n.code,{children:"string[]"}),` | Other fields to "chain" validate when this field is validated. Fields can safely chain validate each other without causing infinite validation. |
| `,e.jsx(n.code,{children:"id"})," | | ",e.jsx(n.code,{children:"string"}),` | The ID given to the containing element. |
| `,e.jsx(n.code,{children:"onBlurCb"})," | | ",e.jsx(n.code,{children:"() => void"}),` | Callback to invoke when the field loses focus. |
| `,e.jsx(n.code,{children:"onChangeCb"})," | | ",e.jsx(n.code,{children:"(value: any) => void"}),` | Callback to invoke when the value of the field changes. |
| `,e.jsx(n.code,{children:"show"})," | | ",e.jsx(n.code,{children:"MosaicToggle<FormState>"})," | Whether or not to render the field. Callbacks are invoked with the current form state. |"]}),`
...
`,e.jsxs(n.p,{children:[`| Name | Options | Failure message | Description |
| ---- | ------- | --------------- | ----------- |
| `,e.jsx(n.code,{children:"required"})," | | ",e.jsx(n.em,{children:"This field is required, please fill it"})," | Validate a string or an array has a length of more than 0. This validator is automatically applied to fields with the ",e.jsx(n.code,{children:"required: true"}),` property in their field definition. |
| `,e.jsx(n.code,{children:"validateEmail"})," | | ",e.jsx(n.em,{children:"The value is not a valid email"}),` | Validates a string is an email address. |
| `,e.jsx(n.code,{children:"validateLatitude"})," | | ",e.jsx(n.em,{children:"Latitude should be between -90 and 90"}),` | Validates a value is a number between -90 and 90. |
| `,e.jsx(n.code,{children:"validateLongitude"})," | | ",e.jsx(n.em,{children:"Longitude should be between -180 and 180"}),` | Validates a value is a number between -180 and 180. |
| `,e.jsx(n.code,{children:"validateNumber"})," | | ",e.jsx(n.em,{children:"The value is not a number"}),` | Validates a string value is a number when cast. |
| `,e.jsx(n.code,{children:"validateURL"})," | | ",e.jsx(n.em,{children:"The value is not a valid URL"}),` | Validates a string value is a valid, complete URL. |
| `,e.jsx(n.code,{children:"validateDateRange"})," | ",e.jsx(n.code,{children:"{ startDateName?: string, endDateName?: string }"})," | ",e.jsx(n.em,{children:"Start date should happen before the end date"})," or ",e.jsx(n.em,{children:"End date should happen after the start date"}),` | Validates a value is a date that preceeds the value of another date field or vise versa. Generally it is used to support date ranges. |
| `,e.jsx(n.code,{children:"validateCharacterCount"})," | ",e.jsx(n.code,{children:"{ max?: number }"})," | ",e.jsx(n.em,{children:"You have exceeded the maximum number of characters"}),` | Validates that a string value does not exceed a maximum number of characters. |
| `,e.jsx(n.code,{children:"validatePhoneNumber"})," | | ",e.jsx(n.em,{children:"Phone number must be exactly 10 numbers excluding the country code"}),` | Validates that a string value contains 10 digits if it starts with 1. In other words, it validates a US phone number. |
| `,e.jsx(n.code,{children:"validateSlow"})," | | ",e.jsx(n.em,{children:"String cannot include test"})," | ",e.jsx(n.strong,{children:"Exists only for testing."}),' Takes a second to validate and fails if the value is a string that contains "test". |']}),`
...
`]})]})}function Te(i={}){const{wrapper:n}={...o(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(t,{...i})}):t(i)}export{Te as default};
