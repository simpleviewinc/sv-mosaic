...
| ---- | ---- | ----------- |\r
| `,t.jsx(r.strong,{children:t.jsx(r.code,{children:"placeholder"})})," | ",t.jsx(r.code,{children:"string"}),` | Optional - Example text shown inside of the text field portion of the dropdown. |\r
| `,t.jsx(r.strong,{children:t.jsx(r.code,{children:"options"})})," | ",t.jsx(r.code,{children:"MosaicLabelValue[]"}),` | required - Array of options to be displayed on the options. |\r
| `,t.jsx(r.strong,{children:t.jsx(r.code,{children:"getOptions"})})," | ",t.jsx(r.code,{children:"() => Promise<MosaicLabelValue[]>"})," | required - Function to get a set of options. This prop only applies when getting options from a DB. |"]}),`
