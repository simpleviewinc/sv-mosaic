...
`]}),`
`,t.jsxs(n.p,{children:[`| Name | Type | Description |
| ---- | ---- | ----------- |
| `,t.jsx(n.strong,{children:t.jsx(n.code,{children:"dataView"})})," | ",t.jsx(n.code,{children:"DataViewProps"})," | Data view configurations (see ",t.jsx(n.a,{href:"https://simpleviewinc.github.io/sv-mosaic/master/?path=/docs/components-dataview-readme--page#props",rel:"nofollow",children:"DataView props"}),`).|
| `,t.jsx(n.strong,{children:t.jsx(n.code,{children:"buttons"})})," | ",t.jsx(n.code,{children:"ButtonAttrs[]"})," | List of buttons that will be display above the data view (see ",t.jsx(n.a,{href:"#buttonattrs-type",children:"ButtonAttrs type"}),"). |"]}),`
...
`})})]})}function kt(i={}){const{wrapper:n}={...e(),...i.components};return n?t.jsx(n,{...i,children:t.jsx(o,{...i})}):o(i)}export{kt as default};
