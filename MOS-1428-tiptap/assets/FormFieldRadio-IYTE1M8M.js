...
| ---- | ---- | ----------- |\r
| `,t.jsx(r.strong,{children:t.jsx(r.code,{children:"options"})})," | ",t.jsx(r.code,{children:"MosaicLabelValue[]"}),` | required - Predefined set of mutually exclusive options. |\r
...
`})})]})}function Dt(o={}){const{wrapper:r}={...n(),...o.components};return r?t.jsx(r,{...o,children:t.jsx(i,{...o})}):i(o)}export{Dt as default};
