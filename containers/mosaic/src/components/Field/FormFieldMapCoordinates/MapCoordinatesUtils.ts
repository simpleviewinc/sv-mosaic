...
import type { IAddress } from "@root/components/Field/FormFieldAddress/AddressTypes";
...
export function isValidLatLng(latLng: MapPosition | undefined): latLng is MapPosition {
	...
	if (typeof validateLatitude(latLng.lat) === "string" || typeof validateLongitude(latLng.lng) === "string") {
		return false;
	}
