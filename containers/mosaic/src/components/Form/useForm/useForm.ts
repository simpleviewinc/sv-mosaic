...
import { FieldDefSanitized, FormFieldTextEditorTipTapExperimental } from "../../Field";
		...
		if (field.inputSettings?.maxCharacters > 0) {
			validators.push({
				...
				options: {
					...
					ignoreHTML: field.type === "textEditor" || field.type === FormFieldTextEditorTipTapExperimental,
				},
			});
		}
