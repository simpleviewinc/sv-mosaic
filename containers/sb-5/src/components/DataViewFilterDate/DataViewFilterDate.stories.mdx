...
<Meta title="Components/DataViewFilterDate/Readme"/>
...
https://github.com/simpleviewinc/sv-mosaic/blob/develop/src/components/DataViewFilterDate/DataViewFilterDateTypes.ts
