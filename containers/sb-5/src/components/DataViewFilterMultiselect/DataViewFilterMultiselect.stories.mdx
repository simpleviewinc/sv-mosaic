...
import * as stories from "./DataViewFilterMultiselect.stories";

<Meta title="Components/DataViewFilterMultiselect/Readme"/>

# DataViewFilterMultiselect

`DataViewFilterMultiselect` is a filter that can be used to pick multiple values from an array of options.
...
https://github.com/simpleviewinc/sv-mosaic/blob/develop/src/components/DataViewFilterMultiselect/DataViewFilterMultiselectTypes.ts
