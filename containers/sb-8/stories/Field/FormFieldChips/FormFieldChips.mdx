...
import * as stories from './FormFieldChips.stories';
...
- The `FormFieldChips` component is built over a wrapper for [MUI Autocomplete](https://mui.com/material-ui/react-autocomplete/#main-content) but with SimpleView brand colors.
