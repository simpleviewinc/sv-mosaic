...
import * as stories from "./Card.examples.stories.tsx";
...
<Example component={stories.Base}>{`export function Base() {
	return (
		<Card {...common} />
	);
}`}</Example>
...
<Example component={stories.TopActions}>{`export function TopActions() {
	return (
		<Card
			{...common}
...
<Example component={stories.BottomActions}>{`export function BottomActions() {
	return (
		<Card
			{...common}
...
<Example component={stories.TitleIcon}>{`export function TitleIcon() {
	return (
		<Card
			{...common}
			titleIcon={InfoIcon}
...
<Example component={stories.Count}>{`export function Count() {
	return (
		<Card
			{...common}
			count={5}
