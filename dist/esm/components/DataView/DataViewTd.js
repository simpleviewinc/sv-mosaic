...
function DataViewTd(props) {
    ...
    return (React.createElement(StyledTd, { className: `
			...
			` },
        React.createElement(BodyText, { as: "div", className: `
					${noWrap ? "noWrap" : ""}
					${ellipsis ? "ellipsis" : ""}
				`, style: { maxWidth, textTransform }, title: ellipsis ? props.children : undefined }, props.children)));
}
