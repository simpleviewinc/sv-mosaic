...
function DataViewViewDrawerContent(props) {
    ...
    return (React.createElement(DrawerContent, { title: t("mosaic:DataView.saved_views"), onClose: props.onClose },
        state.options &&
            React.createElement(DataView, { ...DataViewConfig }),
        React.createElement(DataViewViewSaveDrawer, { open: state.formOpen, data: state.formData, onClose: closeForm, onSave: props.onSave, allowSharedViewSave: props.allowSharedViewSave })));
}
