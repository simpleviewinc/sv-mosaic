...
function DataViewFilterDropdown(props) {
    ...
    return (React.createElement(Popover, { anchorEl: props.anchorEl, onClose: props.onClose, open: Boolean(props.anchorEl), TransitionProps: {
            onExited,
            onEntered: props.onEntered
        } },
        React.createElement(StyledWrapper, null, props.children)));
}
