...
function DataViewFilterMultiselect(props) {
    ...
    return (React.createElement(StyledWrapper, null,
        ...
        React.createElement(DataViewFilterDropdown, { anchorEl: state.anchorEl, onClose: onClose, onEntered: onEntered, onExited: onExited },
            React.createElement(DataViewFilterMultiselectDropdownContent, { value: value, comparison: comparison, comparisons: activeComparisons, selected: state.selected, getOptions: props.args.getOptions, isOpen: state.dropdownOpen, onApply: onApply, onClose: onClose, placeholder: (_a = props.args) === null || _a === void 0 ? void 0 : _a.placeholder }))));
}
