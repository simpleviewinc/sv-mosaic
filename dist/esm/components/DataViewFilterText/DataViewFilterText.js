...
function DataViewFilterText(props) {
    ...
    return (React.createElement(StyledWrapper, null,
        ...
        React.createElement(DataViewFilterDropdown, { anchorEl: anchorEl, onClose: onClose },
            React.createElement(DataViewFilterTextDropdownContent, { value: value, onChange: props.onChange, comparison: comparison, comparisons: activeComparisons, onClose: onClose, placeholder: (_a = props.args) === null || _a === void 0 ? void 0 : _a.placeholder }))));
}
