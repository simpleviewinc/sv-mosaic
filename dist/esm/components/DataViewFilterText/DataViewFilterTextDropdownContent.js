...
function DataViewFilterTextDropdownContent(props) {
    ...
    if (props.comparisons) {
        ...
        comparisonButton = (React.createElement(Button, { className: "comparisonButton", label: activeComparison.label, variant: "text", color: "black", iconPosition: "right", mIcon: ExpandMoreIcon, menuItems: menuItems }));
    }
    return (React.createElement(StyledContents, null,
        React.createElement("div", { className: "inputRow" },
            React.createElement(TextField, { autoFocus: true, className: disabled ? "disabled" : "", disabled: disabled, placeholder: props.placeholder || t("mosaic:common.filter___"), margin: "dense", value: state.value, variant: "outlined", onChange: onInputChange, onKeyPress: onKeyPress }),
            comparisonButton),
