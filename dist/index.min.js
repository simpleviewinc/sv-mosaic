...
function LeftNavScroller(props) {
  return /*#__PURE__*/React.createElement(StyledDiv$7, {
    className: props.className
  }, props.children);
}
...
function LeftNavItemDesktop(props) {
  ...
  var onMouseEnter = "PointerEvent" in window ? undefined : onPointerEnter;
  var onMouseLeave = "PointerEvent" in window ? undefined : onPointerLeave; // If this item is unmounted we need to clear the timer
...
var leaveTimeout = 200; // how long to wait onMouseEnter to show the navigation
