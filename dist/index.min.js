...
var StyledDiv$8 = styled.div(_templateObject$F(), theme.colors.gray600);
var leaveTimeout = 200;
...
function LeftNav(props) {
  ...
  var children = props.items.map(function (item) {
    var Component = item.type === "group" && props.variant !== "icons_only" ? LeftNavGroup : LeftNavItem;
    return /*#__PURE__*/React.createElement(Component, {
      key: item.name,
      item: item,
      showLabel: showLabel,
  ...
  var navContent = /*#__PURE__*/React.createElement(StyledDiv$8, {
    onMouseLeave: onMouseLeave,
    onMouseEnter: onMouseEnter
    ...
    className: "bottom"
  }, /*#__PURE__*/React.createElement(LeftNavItem, {
    item: settingsItem,
    showLabel: showLabel,
    openAnchorEl: state.openAnchorEl,
    onOpen: onOpen
