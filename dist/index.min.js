...
function DrawerTopBar(props) {
  var _useMosaicTranslation = i18n.useMosaicTranslation(),
 ...
 */
function addCoreResourceBundle(_ref) {
  ...
  for (var _i = 0, _Object$entries = Object.entries(bundle); _i < _Object$entries.length; _i++) {
    ...
    defaulti18n.addResourceBundle(_lang, "mosaic", _defineProperty({}, prefix, data), true, false);
  }
}
...
function (_React$Component) {
  ...
  function Calendar() {
    ...
    _this = _possibleConstructorReturn$1(this, (_getPrototypeOf2 = _getPrototypeOf$1(Calendar)).call.apply(_getPrototypeOf2, [this].concat(args)));
    _this.state = {
      slideDirection: 'left',
...
/*#__PURE__*/
function (_React$Component) {
  _inherits$1(ClockPointer, _React$Component);
  ...
  function ClockPointer() {
    ...
    _this = _possibleConstructorReturn$1(this, (_getPrototypeOf2 = _getPrototypeOf$1(ClockPointer)).call.apply(_getPrototypeOf2, [this].concat(args)));
    _this.state = {
...
/*#__PURE__*/
function (_React$Component) {
  _inherits$1(Clock, _React$Component);
  ...
  function Clock() {
    ...
    _this = _possibleConstructorReturn$1(this, (_getPrototypeOf2 = _getPrototypeOf$1(Clock)).call.apply(_getPrototypeOf2, [this].concat(args)));
...
Picker.defaultProps = _objectSpread$1$1({}, datePickerDefaultProps, {
...
var KeyboardDateInput = function KeyboardDateInput(_ref) {
  ...
  return React.createElement(Rifm, {
    ...
    return React.createElement(TextFieldComponent, _extends$1({
      ...
      onChange: onChange,
      variant: inputVariant,
      InputProps: _objectSpread$1$2({}, InputProps, _defineProperty$2({}, "".concat(position, "Adornment"), React.createElement(InputAdornment, _extends$1({
        position: position
...
var LeftNavRoot = styled.div(_templateObject$B());
...
var StyledH3 = styled.h3(_templateObject$C(), theme.colors.gray400, theme.fontFamily);
...
var StyledDiv$6 = styled.div(_templateObject$D(), theme.colors.gray700);
...
var StyledA = styled.a(_templateObject$E(), theme.colors.gray400, theme.colors.blue, theme.colors.blueHover, theme.colors.gray200);
...
function LeftNavItem(props, ref) {
  ...
  return /*#__PURE__*/React.createElement(StyledA, _extends({}, attrs, {
    ref: ref,
...
var StyledDiv$7 = styled.div(_templateObject$F());
...
var RootDiv = styled(LeftNavRoot)(_templateObject$G(), theme.colors.gray600, theme.colors.gray400, theme.colors.gray400, theme.colors.gray700);
...
var StyledDiv$8 = styled.div(_templateObject$H()); // set aside the popperProps so they do not mutate between renders, cause the Popper system to go haywire and move the component around strangely
...
function LeftNavFlyout(props) {
  ...
  var onScroll = lodash.throttle(function () {
...
function LeftNavItemDesktop(props) {
  ...
  var onNavClick = React.useCallback(function () {
    leftNavContext.onNav({
      item: item
    });
  }, [leftNavContext.onNav]);
...
var RootDiv$1 = styled(LeftNavRoot)(_templateObject$I(), theme.colors.gray600);
...
function LeftNavDesktop(props) {
  ...
  var items = props.variant === "icons_only" ? props.items.map(function (val) {
  ...
  var settingsItem = {
    ...
    items: [{
      name: "_internal.full",
      label: "Full".concat(activeLabel("full"))
    }, {
      name: "_internal.icons_only",
      label: "Icons Only".concat(activeLabel("icons_only"))
    }, {
      name: "_internal.hidden",
      label: "Hidden".concat(activeLabel("hidden"))
    }]
  ...
  var navContent = /*#__PURE__*/React.createElement(RootDiv$1, {
    ...
    className: "bottom"
  }, /*#__PURE__*/React.createElement(LeftNavItemDesktop, {
    item: settingsItem,
    showLabel: showLabel,
    openName: state.openName,
    onOpen: onOpen
