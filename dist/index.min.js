...
var StyledMenuItem = styled(MUIMenuItem)(_templateObject(), theme.fontFamily);
...
function FilterDate(props) {
  ...
  if (hasStart && hasEnd && momentStart.isSame(momentEnd)) {
    ...
    valueString = "from ".concat(momentStart.format(dateFormat));
  } else if (hasEnd) {
    valueString = "to ".concat(momentEnd.format(dateFormat));
  }
...
var StyledWrapper$e = styled.span(_templateObject$u());
function FilterSingleSelect(props) {
  ...
  return React.createElement(StyledWrapper$e, null, React.createElement(DataViewPrimaryFilter, {
    label: props.label,
    value: valueString,
    type: props.type,
    onRemove: props.onRemove,
