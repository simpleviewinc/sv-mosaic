...
function GridTHead(props) {
  ...
  var columnCount = (props.bulkActions ? 1 : 0) + 1 + props.columns.length; // To show the bulkAll header we need bulkActions/limit/count, at least one registered onAllClick, and all checkboxes selected

  var showBulkAll = props.bulkActions && props.limit > 0 && props.count > 0 && props.bulkActions.some(function (action) {
