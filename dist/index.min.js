...
function BodyText(props) {
  ...
  return React.createElement(Styled, _extends({}, attrs, remaining), props.children);
}
...
function H1(props) {
  ...
  return React.createElement(Styled$1, _extends({}, attrs, remaining), props.children);
}
...
function H3(props) {
  ...
  return React.createElement(Styled$2, _extends({}, attrs, remaining), props.children);
}
...
function CheckboxList(props) {
  ...
  return React__default.createElement(StyledDiv, null, React__default.createElement(List, {
    ...
    return React__default.createElement(ListItem, {
      ...
      checked: checked,
      disableRipple: true
    })), React__default.createElement(BodyText, null, option.label));
  })));
}

var MenuBaseContext = React.createContext(null);
function MenuBase(props) {
  return React.createElement(MUIMenu, {
    anchorEl: props.anchorEl,
    open: props.open,
    onClose: props.onClose
  }, React.createElement(MenuBaseContext.Provider, {
    value: {
      onClose: props.onClose
    }
  }, props.children));
...
function MenuItem(props) {
  ...
  return React.createElement(StyledMenuItem, _extends({}, attrs, {
    onClick: props.onClick,
    disabled: props.disabled,
    selected: props.selected
  }), props.mIcon && React.createElement(MyIcon, {
    className: "icon"
  }, React.createElement(Icon, null)), React.createElement(BodyText, {
    className: "menuLabel"
  }, props.label));
}
...
function Menu(props) {
  ...
  return React__default.createElement(MenuBase, {
    anchorEl: props.anchorEl,
    open: props.open,
    onClose: props.onClose
  }, menuItems);
...
function Button(props) {
  ...
  return React.createElement(MyButton, _extends({}, attrs, {
    className: "\n\t\t\t\t".concat(props.className ? props.className : "", "\n\t\t\t\tbutton\n\t\t\t\t").concat(props.variant === "icon" ? "iconButton" : "normalButton", "\n\t\t\t\tsize_").concat(size, "\n\t\t\t\tvariant_").concat(props.variant, "\n\t\t\t")
  }), props.variant !== "icon" && React.createElement(Button$2, {
    variant: props.variant,
    onClick: onClick,
    size: size,
    fullWidth: props.fullWidth,
    disabled: props.disabled
  }, props.mIcon && iconPosition === "left" && React.createElement(MaterialIcon, {
    className: "icon icon_left",
    style: {
      color: props.mIconColor
    }
  }), props.label, props.mIcon && iconPosition === "right" && React.createElement(MaterialIcon, {
    className: "icon icon_right",
    style: {
      color: props.mIconColor
    }
  })), props.variant === "icon" && React.createElement(IconButton, {
    onClick: onClick,
    disabled: props.disabled
  }, props.mIcon && React.createElement(MaterialIcon, {
    className: "icon"
  })), props.menuItems && React.createElement(Menu, {
    items: props.menuItems,
    anchorEl: anchorEl,
    open: Boolean(anchorEl),
    onClose: closeMenu
  }), props.menuContent && React.createElement(MenuBase, {
    anchorEl: anchorEl,
    open: Boolean(anchorEl),
    onClose: closeMenu
  }, props.menuContent), props.popover && React.createElement(Popover, {
  ...
  }, React.createElement(PopoverWrapper, null, props.popover)));
}
...
function DataViewViewSaveDrawerContent(props) {
  ...
  return React__default.createElement(DrawerContent$1, {
    ...
    required: true,
    variant: "filled"
  })), props.allowSharedViewSave && React__default.createElement(FormGroup, {
    row: true
...
function TitleBar(props) {
  ...
  return React__default.createElement(StyledWrapper$2, null, React__default.createElement("div", {
    className: "left"
...
function MenuSelect(props) {
  ...
  return React.createElement(React.Fragment, null, menuItems);
}
...
function DataViewControlDisplay(props) {
  ...
  var menuContent = React.createElement(MenuSelect, {
    options: options,
    onChange: props.onDisplayChange,
    value: props.display
  });
  return React.createElement(StyledSpan, null, React.createElement(Button$1, {
    variant: "text",
    color: "black",
    label: React.createElement(Icon, null),
    iconPosition: "right",
    size: "small",
    mIcon: ExpandMoreIcon,
...
function DataViewPager(props) {
  ...
  return React.createElement(StyledSpan$1, null, React.createElement(Button$1, {
    color: "black",
    variant: "icon",
    size: "small",
    ...
    className: "pagerText"
  }, startItem, "-", endItem, " of ", props.count), React.createElement(Button$1, {
    color: "black",
    variant: "icon",
    size: "small",
...
var StyledDiv$3 = styled.div(_templateObject$g());
var PopoverDiv = styled.div(_templateObject2$2());
...
function DataViewFilters(props) {
  ...
  return React.createElement(StyledDiv$3, null, React.createElement("div", {
    className: "filterRow"
  ...
  }), optionalFilters.length > 0 && React.createElement(Button$1, {
    label: "More",
    variant: "text",
    color: "black",
    size: "small",
    ...
    mIcon: ExpandMoreIcon,
    mIconColor: theme.colors.gray600,
    popover: React.createElement(PopoverDiv, {
...
var StyledWrapper$3 = styled.div(_templateObject$h(), theme.h2);
...
function GridColumnDrawerContent(props) {
  ...
  return React__default.createElement(DrawerContent$1, {
    ...
    onClose: props.onClose,
    onCancel: props.onClose
  }, React__default.createElement(StyledWrapper$3, null, React__default.createElement("div", {
    className: "left"
...
function DataViewBulkActionsButtonsRow(props) {
  ...
  return React.createElement(ButtonRow$1, {
    buttons: buttons
  });
}
...
var StyledWrapper$4 = styled.thead(_templateObject$i());
...
function GridTHead(props) {
  ...
  return React__default.createElement(StyledWrapper$4, null, React__default.createElement("tr", null, props.bulkActions && React__default.createElement(StyledTh, {
    key: "_bulk",
    className: "bulk"
  }, React__default.createElement(Checkbox$1, {
    checked: allChecked,
    onClick: props.onCheckAllClick
  })), props.bulkActions && anyChecked && React__default.createElement(StyledTh, {
    key: "_bulk_actions",
    colSpan: props.columns.length + 1
  }, React__default.createElement(DataViewBulkActionsButtonsRow$1, {
    data: props.data,
    checked: props.checked,
...
var StyledTd = styled.td(_templateObject$j(),
...
var StyledTBody = styled.tbody(_templateObject$k(), theme.borders.lightGray);
...
var StyledTable = styled.table(_templateObject$l());
...
function DataViewDisplayList(props) {
  ...
  return React.createElement(StyledTable, null, React.createElement(GridTHead, {
    checked: props.checked,
...
var StyledDiv$4 = styled.div(_templateObject$m(),
...
function DataViewDisplayGridSortControl(props) {
  ...
  return React.createElement(StyledDiv$4, null, React.createElement(Button$1, {
    label: activeColumn.label,
    variant: "text",
    color: "black",
    size: "small",
    menuContent: React.createElement(MenuSelect, {
...
var StyledDiv$5 = styled.div(_templateObject$n(),
/* Borders on sticky elements don't carry through, so we put them on the :after element */
...
function DataViewDisplayGrid(props) {
  ...
  return React.createElement(StyledDiv$5, null, hasTopRow && React.createElement("div", {
    className: "topRow"
  }, React.createElement("div", {
    className: "left"
  }, props.bulkActions && React.createElement(Checkbox$1, {
    checked: allChecked,
    onClick: props.onCheckAllClick
  }), props.bulkActions && anyChecked && React.createElement(DataViewBulkActionsButtonsRow$1, {
    data: props.data,
    checked: props.checked,
    bulkActions: props.bulkActions
  })), hasSortControl && React.createElement("div", {
    className: "right"
  }, React.createElement(DataViewDisplayGridSortControl$1, {
    columns: props.columns,
    sort: props.sort,
    onSortChange: props.onSortChange
  }))), React.createElement("div", {
    ...
    return React.createElement("div", {
      ...
      className: "image"
    }, props.bulkActions && React.createElement("div", {
      ...
      className: "left"
    }, primary && React.createElement("h2", null, primary), secondary && React.createElement("h3", null, secondary)), React.createElement("div", {
      className: "right"
    }, React.createElement(GridActionsButtonRow$1, {
      primaryActions: props.primaryActions,
      additionalActions: props.additionalActions,
      row: row
    }))));
...
var StyledWrapper$5 = styled.div(_templateObject$o(), theme.fontFamily);
...
function DataView(props) {
  ...
  return React__default.createElement(StyledWrapper$5, {
    ...
    className: "right"
  }, displayControlEnabled && React__default.createElement(DataViewControlDisplay$1, {
    display: display,
    displayOptions: displayOptionsFull,
    onDisplayChange: props.onDisplayChange
  }), props.onLimitChange !== undefined && React__default.createElement(DataViewControlLimit, {
    limit: props.limit,
...
var LabelWrapper = styled.div(_templateObject$p(), theme.colors.gray600, theme.colors.blue, theme.colors.blue, theme.fontWeight.normal, theme.colors.blue);
...
function DataViewPrimaryFilter(props) {
  ...
  var label = React__default.createElement(LabelWrapper, {
    className: "\n\t\t\t\ttype_".concat(props.type, "\n\t\t\t")
  }, React__default.createElement(BodyText, {
    className: "filterLabel"
  }, props.label, ":"), React__default.createElement(BodyText, {
...
var StyledWrapper$6 = styled.div(_templateObject$q());
...
function DataViewFilterDropdownButtons(props) {
  ...
  return React__default.createElement(StyledWrapper$6, null, React__default.createElement(ButtonRow$1, null, React__default.createElement(Button$1, {
    label: "Clear",
    color: "black",
    variant: "text",
...
var StyledContents = styled.div(_templateObject$r(), theme.colors.blue);
...
var StyledWrapper$7 = styled.div(_templateObject$s(), theme.fontFamily);
...
function DataViewFilterDropdown(props) {
  ...
  }, React__default.createElement(StyledWrapper$7, null, props.children));
}
...
var StyledWrapper$8 = styled.span(_templateObject$t());
...
function DataViewFilterText(props) {
  ...
  return React__default.createElement(StyledWrapper$8, null, React__default.createElement(DataViewPrimaryFilter, {
    label: props.label,
    value: valueString,
    type: props.type,
    onRemove: props.onRemove,
...
var StyledWrapper$9 = styled.div(_templateObject$u(), theme.iconFontSize, theme.fontFamily, theme.colors.blue, theme.colors.blue, theme.fontFamily, theme.colors.blue);
...
function DataViewFilterMultiselectDropdownContent(props) {
  ...
  if (props.comparisons) {
    ...
    }, React__default.createElement(H3, null, "Comparison"), React__default.createElement(ButtonRow$1, null, React__default.createElement(Button$1, {
      label: activeComparison.label,
      variant: "outlined",
      color: "black",
      iconPosition: "right",
  ...
  return React__default.createElement(StyledWrapper$9, null, React__default.createElement("div", {
    className: "topBlock"
  }, React__default.createElement("div", {
    ...
    className: "selected"
  }, comparisonDropdown, React__default.createElement(H3, null, "Selected Options"), React__default.createElement("div", {
    className: "chips"
...
var StyledWrapper$a = styled.span(_templateObject$v());
...
function DataViewFilterMultiselect(props) {
  ...
  return React__default.createElement(StyledWrapper$a, null, React__default.createElement(DataViewPrimaryFilter, {
    label: props.label,
    value: valueString,
    type: props.type,
    onRemove: props.onRemove,
...
var StyledWrapper$b = styled.div(_templateObject$w(), theme.fontFamily);

function Dialog(props) {
  return React__default.createElement(StyledWrapper$b, null, React__default.createElement("div", {
    className: "mask"
  }), React__default.createElement("div", {
    className: "container"
...
var StyledContents$1 = styled.div(_templateObject$x(), theme.colors.red);
function FilterDateDropdownContent(props) {
  ...
  }, React.createElement("h5", null, "From"), React.createElement(DatePicker, _extends({}, pickerArgs, {
    value: state.rangeStart || null,
    onChange: getOnChange("rangeStart")
  }))), React.createElement("div", {
    className: "endRange"
  }, React.createElement("h5", null, "To"), React.createElement(DatePicker, _extends({}, pickerArgs, {
...
var StyledWrapper$c = styled.span(_templateObject$y());
...
function FilterDate(props) {
  ...
  return React.createElement(StyledWrapper$c, null, React.createElement(DataViewPrimaryFilter, {
    label: props.label,
    value: valueString,
    type: props.type,
    onRemove: props.onRemove,
...
function FilterSingleSelectContent(props) {
  return React.createElement(MenuBase, {
    anchorEl: props.anchorEl,
    open: Boolean(props.anchorEl),
    onClose: props.onClose
  }, props.children);
...
var StyledWrapper$d = styled.span(_templateObject$z());
function FilterSingleSelect(props) {
  ...
  return React.createElement(StyledWrapper$d, null, React.createElement(DataViewPrimaryFilter, {
    ...
    onRemove: props.onRemove,
    onClick: onClick
  }), React.createElement(FilterSingleSelectContent, {
    onClose: onClose,
    anchorEl: state.anchorEl
