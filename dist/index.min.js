...
var StyledCheckbox = styled(MUICheckbox)(_templateObject(), theme.colors.blue);
...
var Styled = styled.span(_templateObject$1(), theme.fontFamily, theme.colors.black);
function BodyText(props) {
  ...
  return /*#__PURE__*/React.createElement(Styled, _extends({}, attrs, remaining), props.children);
}
...
var Styled$1 = styled.h1(_templateObject$2(), theme.fontFamily, theme.colors.black);
function H1(props) {
  var children = props.children,
      _props$attrs = props.attrs,
      attrs = _props$attrs === void 0 ? {} : _props$attrs,
  ...
  return /*#__PURE__*/React.createElement(Styled$1, _extends({}, attrs, remaining), props.children);
}
...
var Styled$2 = styled.h3(_templateObject$3(), theme.fontFamily, theme.colors.black);
function H3(props) {
  var children = props.children,
      _props$attrs = props.attrs,
      attrs = _props$attrs === void 0 ? {} : _props$attrs,
  ...
  return /*#__PURE__*/React.createElement(Styled$2, _extends({}, attrs, remaining), props.children);
}
...
function CheckboxList(props) {
  ...
  return /*#__PURE__*/React__default.createElement(StyledDiv, null, /*#__PURE__*/React__default.createElement(List, {
    dense: true
    ...
    return /*#__PURE__*/React__default.createElement(ListItem, {
      ...
      checked: checked,
      disableRipple: true
    })), /*#__PURE__*/React__default.createElement(BodyText, null, option.label));
  })));
}
...
var StyledMenuItem = styled(MUIMenuItem)(_templateObject$5(), theme.iconFontSize, theme.fontFamily);
...
var ButtonWrapper = styled.span(_templateObject$6(), theme.fontFamily, theme.fontWeight.semiBold, theme.iconFontSize);
...
function Button(props) {
  ...
  }), props.variant !== "icon" && /*#__PURE__*/React.createElement(Button$2, {
  ...
  })), props.variant === "icon" && /*#__PURE__*/React.createElement(IconButton, {
    onClick: onClick,
    disabled: props.disabled
...
var StyledWrapper = styled.span(_templateObject$7(),
...
var DrawerContent = styled.div(_templateObject$8(), theme.fontFamily);
...
var StyledWrapper$1 = styled.div(_templateObject$9());
...
var StyledDiv$1 = styled.div(_templateObject$a());
...
var StyledDiv$2 = styled.div(_templateObject$b());

function DrawerContent$1(props) {
  return /*#__PURE__*/React__default.createElement(StyledDiv$2, null, /*#__PURE__*/React__default.createElement(DrawerTopBar, {
    title: props.title,
    onSave: props.onSave,
...
var ViewSpan = styled.span(_templateObject$c());
...
var StyledWrapper$2 = styled.div(_templateObject$d());
...
var StyledSpan = styled.span(_templateObject$e(), theme.iconFontSize);
...
var PopoverDiv = styled.div(_templateObject$f(), theme.colors.red);
...
var StyledSpan$1 = styled.span(_templateObject$g());
...
var StyledDiv$3 = styled.div(_templateObject$h());
...
var StyledWrapper$3 = styled.div(_templateObject$i(), theme.h2);
...
function GridColumnDrawerContent(props) {
  ...
  return /*#__PURE__*/React__default.createElement(DrawerContent$1, {
    ...
    className: "left"
  }, /*#__PURE__*/React__default.createElement("h2", null, "Columns"), /*#__PURE__*/React__default.createElement(CheckboxList, {
    options: columnOptions,
    checked: state.activeColumns,
    onChange: onColumnsChange
  })), /*#__PURE__*/React__default.createElement("div", {
    className: "right"
  }, /*#__PURE__*/React__default.createElement("h2", null, "Column Order"), state.activeColumns.map(function (name, i) {
...
function DataViewBulkActionsButtonsRow(props) {
  var buttons = props.bulkActions.map(function (action) {
    ...
    return _objectSpread2({}, buttonArgs, {
      attrs: {
        "data-mosaic-id": "action_bulk_".concat(action.name)
      },
      onClick: function onClick() {
...
var StyledWrapper$4 = styled.thead(_templateObject$j());
...
var StyledTd = styled.td(_templateObject$k(),
  ...
  var primaryActions = React.useMemo(function () {
    ...
    return props.primaryActions.filter(function (action) {
      ...
      return /*#__PURE__*/React.createElement(Button$1, _extends({}, buttonArgs, {
        key: "primary_".concat(action.name),
        attrs: {
          "data-mosaic-id": "action_primary_".concat(action.name)
        },
        onClick: newOnClick
      }));
    });
    ...
    return [/*#__PURE__*/React.createElement(Button$1, {
      ...
      menuItems: additionalActions.map(function (action) {
        ...
        return _objectSpread2({}, menuArgs, {
          attrs: {
            "data-mosaic-id": "action_additional_".concat(action.name)
          },
          onClick: function onClick() {
            action.onClick({
              data: props.row
...
var StyledTBody = styled.tbody(_templateObject$l(), theme.borders.lightGray);
...
var StyledTable = styled.table(_templateObject$m());
...
var StyledDiv$4 = styled.div(_templateObject$n(),
...
var StyledDiv$5 = styled.div(_templateObject$o(),
/* Borders on sticky elements don't carry through, so we put them on the :after element */
"", theme.borders.gray, theme.colors.gray500);
...
var StyledWrapper$5 = styled.div(_templateObject$p(), theme.fontFamily);
...
function DataView(props) {
  ...
  var idColumn = props.columns.find(function (val) {
    return val.name === "id";
  });
  ...
  var displayOptions = React.useMemo(function () {
    return props.displayOptions || ["list"];
...
var LabelWrapper = styled.div(_templateObject$q(), theme.colors.gray600, theme.colors.blue, theme.colors.blue, theme.fontWeight.normal, theme.colors.blue);
...
var StyledWrapper$6 = styled.div(_templateObject$r());
...
var StyledContents = styled.div(_templateObject$s(), theme.colors.blue);
...
var StyledWrapper$7 = styled.div(_templateObject$t(), theme.fontFamily);
...
var StyledWrapper$8 = styled.span(_templateObject$u());
...
var StyledWrapper$9 = styled.div(_templateObject$v(), theme.iconFontSize, theme.fontFamily, theme.colors.blue, theme.colors.blue, theme.fontFamily, theme.colors.blue);
...
function DataViewFilterMultiselectDropdownContent(props) {
  ...
  if (props.comparisons) {
    ...
    }, /*#__PURE__*/React__default.createElement(H3, null, "Comparison"), /*#__PURE__*/React__default.createElement(ButtonRow$1, null, /*#__PURE__*/React__default.createElement(Button$1, {
      label: activeComparison.label,
      variant: "outlined",
      color: "black",
      iconPosition: "right",
  ...
  return /*#__PURE__*/React__default.createElement(StyledWrapper$9, null, /*#__PURE__*/React__default.createElement("div", {
    ...
    className: "selected"
  }, comparisonDropdown, /*#__PURE__*/React__default.createElement(H3, null, "Selected Options"), /*#__PURE__*/React__default.createElement("div", {
    className: "chips"
...
var StyledWrapper$a = styled.span(_templateObject$w());
...
var StyledWrapper$b = styled.div(_templateObject$x(), theme.fontFamily);
...
function (_React$Component) {
  ...
  function ClockPointer() {
    ...
    _classCallCheck$1(this, ClockPointer);
...
var StyledContents$1 = styled.div(_templateObject$y(), theme.colors.red);
function FilterDateDropdownContent(props) {
  ...
  var getOnChange = function getOnChange(name) {
    return function (date) {
      ...
      setState(_objectSpread2({}, state, _defineProperty({}, name, date === null ? undefined : date)));
    };
  };
  ...
  }, /*#__PURE__*/React.createElement("h5", null, "From"), /*#__PURE__*/React.createElement(DatePicker, _extends({}, pickerArgs, {
    value: state.rangeStart || null,
    onChange: getOnChange("rangeStart")
  }))), /*#__PURE__*/React.createElement("div", {
    className: "endRange"
  }, /*#__PURE__*/React.createElement("h5", null, "To"), /*#__PURE__*/React.createElement(DatePicker, _extends({}, pickerArgs, {
...
var StyledWrapper$c = styled.span(_templateObject$z());
...
var StyledWrapper$d = styled.span(_templateObject$A());
...
var StyledH3 = styled.h3(_templateObject$B(), theme.colors.gray400, theme.fontFamily);

function LeftNavTitle(props) {
  return /*#__PURE__*/React.createElement(StyledH3, null, props.mIcon && /*#__PURE__*/React.createElement(props.mIcon, {
    className: "icon"
...
var StyledDiv$6 = styled.div(_templateObject$C(), theme.colors.gray700);
...
function LeftNavGroup(props) {
  ...
  }), props.item.items && props.item.items.map(function (item) {
...
var StyledDiv$7 = styled.div(_templateObject$D(), theme.colors.gray400, theme.fontFamily);
...
function LeftNavFlyout(props) {
  ...
  var onOpen = function onOpen(openAnchorEl) {
    setState(_objectSpread2({}, state, {
  ...
  return /*#__PURE__*/React.createElement(Popper, {
    ...
    elevation: 3,
    component: StyledDiv$7,
    className: "paper",
    onMouseLeave: onMouseLeave
  }, /*#__PURE__*/React.createElement(LeftNavTitle, {
    label: props.parent.label
  }), props.parent.items.map(function (val) {
    var Component = val.type === "group" ? LeftNavGroup : LeftNavItem;
    return /*#__PURE__*/React.createElement(Component, {
      key: val.name,
      item: val,
...
var StyledA = styled.a(_templateObject$E(), theme.colors.gray400, theme.colors.gray200);

function LeftNavItem(props) {
  var openAnchorEl = props.openAnchorEl,
      item = props.item,
      onOpen = props.onOpen,
  ...
  var open = aRef.current !== null && openAnchorEl === aRef.current;
  ...
  var clickable = !item.items;
  var hasItems = item.items !== undefined;
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(StyledA, {
    onMouseEnter: onMouseEnter,
    onClick: clickable ? onNav : undefined,
    ref: aRef,
    className: "\n\t\t\t\t\t".concat(clickable ? "clickable" : "", "\n\t\t\t\t\t").concat(hasItems ? "hasItems" : "", "\n\t\t\t\t\t").concat(showLabel ? "showLabel" : "", "\n\t\t\t\t")
...
var StyledButton = styled(Button$2)(_templateObject$F(), theme.colors.gray400, theme.colors.gray400);
function LeftNavSettingsButton(props) {
  var _useState = React.useState({
    anchorEl: null
  }),
      _useState2 = _slicedToArray(_useState, 2),
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(StyledButton, {
    ...
    onClick: onClick
  }, /*#__PURE__*/React.createElement(SettingsIcon, null)), /*#__PURE__*/React.createElement(MenuBase, {
    anchorEl: state.anchorEl,
    open: Boolean(state.anchorEl),
    onClose: onClose
  }, /*#__PURE__*/React.createElement(MenuSelect, {
    options: options,
    value: leftNavContext.variant,
    onChange: leftNavContext.onVariantChange
  })));
}

var LeftNavLocalStorage = /*#__PURE__*/function () {
  function LeftNavLocalStorage() {
    var _props$key;

    var props = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

    _classCallCheck(this, LeftNavLocalStorage);

    this.key = (_props$key = props.key) !== null && _props$key !== void 0 ? _props$key : "sv-mosaic-left-nav-settings";
  }

  _createClass(LeftNavLocalStorage, [{
    key: "get",
    value: function get() {
...
var StyledDiv$8 = styled.div(_templateObject$G());
var defaultStorage = new LeftNavLocalStorage();

function LeftNav(props) {
  var _props$zIndex, _props$settingsStorag;

  var zIndex = (_props$zIndex = props.zIndex) !== null && _props$zIndex !== void 0 ? _props$zIndex : 100;
  var settingsStorage = (_props$settingsStorag = props.settingsStorage) !== null && _props$settingsStorag !== void 0 ? _props$settingsStorag : defaultStorage;
  ...
  React.useEffect(function () {
    ...
    function _get() {
      _get = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
        var _yield$settingsStorag, _settings$variant;
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 2:
                _context.t1 = _yield$settingsStorag = _context.sent;
                ...
                _context.t0 = _yield$settingsStorag !== void 0;
              ...
              case 6:
                ...
                _context.t2 = _yield$settingsStorag;
                _context.next = 11;
                break;
              ...
              case 11:
                settings = _context.t2;
                setState(_objectSpread2({}, state, {
                  variant: (_settings$variant = settings.variant) !== null && _settings$variant !== void 0 ? _settings$variant : "full"
                }));
  ...
  var onVariantChange = function onVariantChange(variant) {
    function set() {
      return _set.apply(this, arguments);
    }

    function _set() {
      _set = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
  ...
  var children = props.items.map(function (item) {
    var Component = item.type === "group" && state.variant !== "icons_only" ? LeftNavGroup : LeftNavItem;
    var showLabel = state.variant === "icons_only" ? false : true;
    return /*#__PURE__*/React.createElement(Component, {
      key: item.name,
      item: item,
      showLabel: showLabel,
  ...
  var drawerVariant = state.variant === "full" || state.variant === "icons_only" ? "persistent" : "temporary";
  var open = drawerVariant === "persistent" ? true : props.open;
  ...
  return /*#__PURE__*/React.createElement(MUIDrawer, {
    anchor: "left",
  ...
  }, /*#__PURE__*/React.createElement(StyledDiv$8, {
    onMouseLeave: onMouseLeave,
    ...
    className: "bottom"
  }, /*#__PURE__*/React.createElement(LeftNavSettingsButton, null)))));
}
