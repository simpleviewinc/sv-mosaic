...
var StyledA = styled.a(_templateObject$E(), theme.colors.gray200, theme.colors.gray200);
...
var StyledDiv$8 = styled.div(_templateObject$F());

function LeftNav(props) {
  var zIndex = props.zIndex !== undefined ? props.zIndex : 100;
  ...
  var children = props.items.map(function (item) {
    var Component = item.type === "group" ? LeftNavGroup : LeftNavItem;
    return /*#__PURE__*/React.createElement(Component, {
      key: item.name,
      item: item,
      openAnchorEl: state.openAnchorEl,
  ...
  }, /*#__PURE__*/React.createElement(StyledDiv$8, null, /*#__PURE__*/React.createElement(LeftNavContext.Provider, {
    value: contextValue
  }, children)));
}
