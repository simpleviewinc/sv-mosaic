...
`;function dc(e){const n=e.displayOptions.find(i=>i.name===e.display).mIcon,r=e.displayOptions.map(i=>({value:i.name,label:i.label,mIcon:i.mIcon})),a=d.jsx(Xt,{options:r,onChange:e.onDisplayChange,value:e.display});return d.jsx(uc,{children:d.jsx(z,{variant:"icon",color:"black",mIcon:n,iconPosition:"right",size:"small",menuContent:a})})}const fc=c.memo(dc),hc=E(z)`
	button {
		font-weight: 400;
	}
`;function gc(e){const t=c.useCallback(function(a){e.onLimitChange({limit:Number(a)})},[e.onLimitChange]),n=c.useMemo(function(){return e.options.map(a=>({label:a.toString(),value:a.toString()}))},[e.options]),r=d.jsx(Xt,{options:n,onChange:t,value:e.limit.toString()});return d.jsx(hc,{color:"black",label:e.limit.toString(),variant:"text",size:"small",iconPosition:"right",mIcon:Lt,mIconColor:A.newColors.almostBlack[100],menuContent:r})}const mc=c.memo(gc),vc=E.div`
	font-size: 14px;
	display: inline-flex;
	align-items: center;
...
`,Cc=E.span`
	font-weight: 400;
`;function yc(e){const{t}=_e(),n=Math.ceil(e.count/e.limit),r=(e.skip+e.limit)/e.limit,a=e.skip+1,i=Math.min(e.skip+e.limit,e.count),o=u=>()=>{e.onSkipChange({skip:u})},s=r===1,l=r===n;return n===0?null:d.jsxs(xc,{children:[d.jsx(z,{color:"black",variant:"text",size:"small",tooltip:t("mosaic:DataView.jump_to_page"),label:d.jsxs("span",{children:[a,"-",i," ",d.jsx(Cc,{children:"of"})," ",e.count]}),popover:d.jsx(wc,{currentPage:r,totalPages:n,limit:e.limit,onSkipChange:e.onSkipChange})}),d.jsx(zn,{color:"gray",variant:"icon",size:"small",mIcon:ba,onClick:o(e.skip-e.limit),disabled:s}),d.jsx(zn,{color:"gray",variant:"icon",size:"small",mIcon:ya,onClick:o(e.skip+e.limit),disabled:l})]})}const kc=c.memo(yc),Dc=E.div`
	align-items: center;
	display: flex;
	justify-content: space-between;
`,pc=E.div`
...
`,Nc=E.div`
  ...
  width: 80px;
`,cu=E(ma)`
`,uu=e=>{const{disabled:t,color:n,onClick:r,displayColorPicker:a,id:i}=e;return d.jsx(Ic,{$disabled:t,$displayColorPicker:a,onClick:r,type:"button",id:i,children:d.jsx(Nc,{"data-testid":"colordiv-test",$disabled:t,$color:n})})};export{Ul as A,Vt as B,uu as C,nc as D,cu as P,Fi as _,lu as a,Aa as b,Ii as c,pe as d,Ea as e,su as f,Ya as g,Dt as h,Xn as i,mt as j,Va as k,Na as l,ou as m,Ua as n,ja as o,Ai as p,Ga as q,Y as r,vt as s,ce as t,Rn as u,Xa as v,P as w,Oa as x,Jn as y,Wt as z};
