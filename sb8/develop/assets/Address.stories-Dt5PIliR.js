...
}`,...(A=(K=t.parameters)==null?void 0:K.docs)==null?void 0:A.source}}};var M,v,B;p.parameters={...p.parameters,docs:{...(M=p.parameters)==null?void 0:M.docs,source:{originalSource:`(): ReactElement => {
  const controller = useForm();
  return <Form {...controller} title="Address Field" fields={fields} />;
}`,...(B=(v=p.parameters)==null?void 0:v.docs)==null?void 0:B.source}}};const H=["Playground","Single","KitchenSink"],V=Object.freeze(Object.defineProperty({__proto__:null,KitchenSink:p,Playground:s,Single:t,__namedExportsOrder:H,default:L},Symbol.toStringTag,{value:"Module"}));export{V as s};
