...
`),De={danger:{contained:`
		...
		`,text:`
			...
			--over-bg: ${a.color.gray[200]};
		`}};function We({$size:e,$isIconButton:o}){return o?[0]:e==="inherit"?[0,"0.25em"]:e==="small"?[0,3]:e==="xsmall"?[0,2]:[0,4]}const _e={xsmall:"24px",small:"32px",medium:"36px",large:"40px",xlarge:"44px",inherit:"auto"};function Ae({$fullWidth:e,$isIconButton:o,$size:n}){const t=_e[n];return e?["100%",t]:o?n==="xsmall"?["24px",t]:n==="small"?["32px",t]:["36px",t]:[void 0,t]}const je=P(Ne)(({$intent:e,$variant:o,$fullWidth:n,$size:t,$isIconButton:i,$bluntLeft:l,$bluntRight:s})=>{const d=We({$size:t,$isIconButton:i}),[u,b]=Ae({$fullWidth:n,$isIconButton:i,$size:t});return`
		&& {
			--bg-top: transparent;
...
`,Co=P.div`
    ...
    `}
`;function Mo({mIcon:e,color:o="black",attrs:n,title:t,onClick:i,disabled:l,selected:s=!1,truncateText:d,autoFocus:u,tabIndex:b,className:h,...p}){const f="children"in p?p.children:null,g="label"in p?p.label:"";if(!de.includes(o))throw new Error("The menu item component only accepts the following colors: "+de.join(", ")+`. The color provided was "${o}"`);const E=c.useMemo(()=>({title:t===!0&&typeof g=="string"?g:typeof t=="string"?t:void 0,...n}),[n,t,g]);return c.createElement($o,{...E,onClick:i,disabled:l,selected:s,className:["menu-item",h].filter(Boolean).join(" "),disableRipple:!0,$truncateText:d,autoFocus:u,tabIndex:b,"aria-selected":s,...p},f??c.createElement(c.Fragment,null,e&&c.createElement(Co,{className:"icon",$color:o},c.createElement(e,null)),c.createElement("div",{className:"menuLabel"},c.createElement("span",null,g))))}function wo({onClose:e,open:o,anchorEl:n,items:t,onChange:i,placeholder:l,value:s}){const d=c.useMemo(()=>[...l?[{label:l,value:void 0}]:[],...t].map(({onClick:h,...p},f)=>{const g=function(){h&&h(),i&&i(p.value),e()};return w.createElement(Mo,{key:f,...p,selected:i&&s===p.value,onClick:g})}),[t,i,e,l,s]);return w.createElement(bo,{anchorEl:n,open:o,onClose:e},d)}function Io(e,o=!0){const n=e!==void 0?e:o,t=Array.isArray(n)?n:[n],i=l=>typeof l=="function"?l():l;return o?t.every(i):t.some(i)}function ee(e,o,n=!0){const t=Array.isArray(e),i=c.useMemo(()=>t?e:[e],[t,e]),l=c.useMemo(()=>i.filter(s=>Io(s[o],n)),[n,i,o]);return t?l:l.length>0}const Eo=P(Se)`
	z-index: 1500;
...
`,So=P.div`
	...
	position: absolute;
`,ko=[{name:"offset",options:{offset:[0,10]}}],Bo=e=>{const{children:o,open:n,placement:t="bottom-start",anchorEl:i,id:l,maxWidth:s}=e,d=c.useMemo(()=>({maxWidth:s}),[s]);return c.createElement(Eo,{open:n,anchorEl:i,placement:t,modifiers:ko,role:"tooltip",id:l,"data-testid":"tooltip-test-id",style:d},c.createElement(So,{className:"arrow"}),o)};function Po(){const[e,o]=c.useState(null),[n,t]=c.useState(!1),i=c.useId(),l=c.useMemo(()=>({open:n,anchorEl:e,id:`tooltip-${i}`}),[n,e,i]),s=c.useMemo(()=>({ref:o,onMouseEnter:()=>t(!0),onMouseLeave:()=>t(!1),"aria-describedby":`tooltip-${i}`}),[i]);return{tooltipProps:l,anchorProps:s}}function J(e,o=!0){const n=c.useRef(!1);c.useEffect(()=>{n.current||!o||(console.warn(e),n.current=!0)})}const Ro=c.createContext(null),zo={anchorOrigin:{vertical:"bottom",horizontal:"left"},transformOrigin:{vertical:"top",horizontal:"left"}},Lo={black:"specialized",blue:"info",gray:"secondary",lightBlue:"secondary",red:"danger",teal:"info",white:"secondary",yellow:"primary"},ve=c.forwardRef(function({size:o="medium",alignItems:n="center",...t},i){var l,s;const d=t.mIcon,u=!t.label&&d,b=t.iconPosition||"left",h=d&&w.createElement(Ve,{as:d,style:{color:t.mIconColor},$isAdornment:!u,$inherit:o==="inherit",$size:u?"md":"sm"}),p=ee(t,"disabled",!1);J("[MOS Button] The `color` prop is deprecated and should no longer be used, it will be removed in a future version. Use the `intent` prop instead.",t.color!==void 0),J("[MOS Button] The `icon` variant is deprecated. Mosaic now infers an icon variant from the use of the `mIcon` prop and the lack of a `label` prop.",t.variant==="icon"),J("[MOS Button] The `outlined` variant is deprecated and should no longer be used, it will be removed in a future version. Use either `contained` or `text`",t.variant==="outlined");const f=(s=(l=t.intent)!==null&&l!==void 0?l:Lo[t.color])!==null&&s!==void 0?s:"secondary",g={$variant:t.variant,$intent:f,$bluntLeft:t.bluntLeft,$bluntRight:t.bluntRight,disabled:t.invisible||p,size:o,$size:o,onClick:t.onClick,onBlur:t.onBlur,href:t.href,name:t.name,id:t.id,type:t.type||"button",as:t.as,ref:i,disableRipple:!0,"aria-label":typeof t.label=="string"?t.label:typeof t.tooltip=="string"?t.tooltip:void 0,...t.muiAttrs},E=["button",t.className,t.variant==="icon"?"iconButton":"normalButton",t.fullWidth&&"fullWidth",t.invisible&&"invisible",`size_${o}`,`variant_${t.variant}`].filter(Boolean).join(" ");return w.createElement(Oe,{...t.attrs,$fullWidth:t.fullWidth,className:E,onMouseEnter:t.onMouseEnter,onMouseLeave:t.onMouseLeave},w.createElement(je,{...g,$fullWidth:t.fullWidth,$isIconButton:u,$alignItems:n},w.createElement(He,null),w.createElement(Ge,{$size:o},b==="left"&&h,t.label&&(typeof t.label=="string"?w.createElement(Ue,null,t.label):t.label),b==="right"&&h)))});function To(e){const{anchorProps:o,tooltipProps:n}=Po(),[t,i]=c.useState(null);function l(f){i(f.currentTarget)}function s(){i(null)}const d=f=>{l(f),e.onClick&&e.onClick(f)},u=e.popoverEvent==="onHover",b=f=>{e.onMouseEnter&&e.onMouseEnter(f),e.popover&&u&&l(f),o.onMouseEnter()},h=f=>{e.onMouseLeave&&e.onMouseLeave(f),e.popover&&u&&s(),o.onMouseLeave()},p=ee(e.menuItems||[],"show",!0);return e.menuItems&&!p.length?null:w.createElement(w.Fragment,null,w.createElement(ve,{...e,onClick:d,onMouseEnter:b,onMouseLeave:h,ref:o.ref}),e.tooltip&&w.createElement(Bo,{...n},e.tooltip),e.popover?w.createElement(be,{open:!!t,anchorEl:t,onClose:s,disableRestoreFocus:!0,style:u?{pointerEvents:"none"}:null,...zo},w.createElement(Ro.Provider,{value:{onClose:s}},e.popover)):e.menuItems?w.createElement(wo,{items:p,onChange:e.menuOnChange,value:e.menuValue,anchorEl:t,open:!!t,onClose:s}):null)}function Fo(e){return ee(e,"show")?e.menuItems||e.popover||e.tooltip?w.createElement(To,{...e}):w.createElement(ve,{...e}):null}const Uo=c.memo(Fo);export{Uo as B,wo as M,Bo as T,ee as a,Mo as b,po as c,Ne as d,bo as e,Ro as f,Io as g,Po as u};
