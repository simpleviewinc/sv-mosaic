import{r}from"./index-wekxHvEx.js";import{t as R}from"./sizes-BeWafy6f.js";import{c as p}from"./styled-components.browser.esm-DDzsJbQW.js";import{u as x,B as $}from"./Button-CdzdKupF.js";import{t as m}from"./testIds-B6Pox1zA.js";import{c as B,a as f,k as g}from"./identifier-Bq1wI7MV.js";import{g as E,a as S,u as U,b as A,s as M,m as T}from"./createSimplePaletteValueFilter-BVevyrl8.js";import{j}from"./jsx-runtime-D_zvdyIk.js";const N=p.div`
	display: flex;
	align-items: center;
...
`,W=p.div`
	...
	${({$separator:t})=>`
		...
		`}
	`}
`;function O(t){return String(t).match(/[\d.\-+]*\s*(.*)/)[1]||""}function X(t){return parseFloat(t)}function I(t){return E("MuiSkeleton",t)}S("MuiSkeleton",["root","text","rectangular","rounded","circular","pulse","wave","withChildren","fitContent","heightAuto"]);const K=t=>{const{classes:e,variant:n,animation:a,hasChildren:o,width:s,height:i}=t;return A({root:["root",n,a,o&&"withChildren",o&&!s&&"fitContent",o&&!i&&"heightAuto"]},I,e)},c=g`
  0% {
    opacity: 1;
  }
