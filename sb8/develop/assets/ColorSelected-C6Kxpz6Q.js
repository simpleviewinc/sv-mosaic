...
`;function _l({ariaLabel:e,expandCell:t=!1,style:n,...r}){const{bold:a=!1,italic:i=!1,strikeThrough:o=!1,noWrap:s=!1,ellipsis:l=!1,...u}=n||{};return d.jsx(Ol,{className:`
				${t?"expandCell":""}
				${a?"bold":""}
				${i?"italic":""}
				${o?"strikeThrough":""}
			`,"aria-label":e,style:u,...r,children:d.jsx("div",{className:`
					${s?"noWrap":""}
					${l?"ellipsis":""}
				`,title:l&&typeof r.children=="string"?r.children:void 0,"data-testid":W.DATA_VIEW_TD_INNER,children:r.children})})}const mt=c.memo(_l),Pl=O(rt)`
    ${({$hidden:e})=>e&&`
        visibility: hidden;
    `}
