import{j as g}from"./jsx-runtime-DiwAibxM.js";import{r as i}from"./index-Btj5Fd67.js";import{c as u,s as p}from"./theme-C7C0QMlu.js";import{t as f}from"./testIds-DZf96GK8.js";import{D as v}from"./ChevronRight-Da8zFjWX.js";import{B as k}from"./Popper-lO7-sb5Y.js";function A(t,n){if(t.length===0)return[];const a=t[t.length-1];return t.map((e,s)=>{const o=s===t.length-1,l=s===t.length-2;return o&&e===!1&&n?"closing":o&&e===!0&&n?"opening":o&&e===!0?"open":l&&a===!0&&n?"stacking":l&&a===!1&&n?"unstacking":"stacked"})}const c=250,x=u`
	from {
	  	right: -75vw;
	}
	to {
