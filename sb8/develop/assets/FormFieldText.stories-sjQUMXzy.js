...
}`,...(q=(R=r.parameters)==null?void 0:R.docs)==null?void 0:q.source}}};var C,j,B;i.parameters={...i.parameters,docs:{...(C=i.parameters)==null?void 0:C.docs,source:{originalSource:`(): ReactElement => {
  const controller = useForm();
  const {
    handleSubmit
  } = controller;
...
}`,...(B=(j=i.parameters)==null?void 0:j.docs)==null?void 0:B.source}}};const D=["Playground","KitchenSink","ValidationStrategies"],W=Object.freeze(Object.defineProperty({__proto__:null,KitchenSink:r,Playground:n,ValidationStrategies:i,__namedExportsOrder:D,default:P},Symbol.toStringTag,{value:"Module"}));export{W as s};
