import{j as m}from"./jsx-runtime-DiwAibxM.js";import{r as a}from"./index-Btj5Fd67.js";import{n as P}from"./index.browser-vcSNLBTf.js";import{m as r,g as M,a as U}from"./options-BxqdWnW5.js";import{u as G,r as B,c as q,F as N,n as j}from"./index-DE-vLMND.js";import{r as K}from"./renderButtons-BmHfsf_z.js";import{O as z}from"./utils-BR2PSRFh.js";import{t as H}from"./testIds-fiKIunms.js";const W={title:"Components/Form"},Z=async i=>{const u=`${i}_${r.length}`,o={label:i,value:u};return r.push(o),o},X={textField:"Text field from getFormValues",check:[{label:"Label 1",value:"label_1"},{label:"Label 2",value:"label_2"}],chipSelect:{label:"Label 1",value:"label_1"},dropdownSingle:{label:"The Dark Knight",value:"2008"},phoneSelect:"15205751152",radio:{label:"Label 2",value:"label_2"},toggle:!0,color:"#a8001791",date:new Date,time:"16:30",address:[{id:1,address1:"8950 N. Oracle Road",city:"Tuczon",postalCode:"85704",country:{label:"United States",value:"US"},state:{label:"Arizona",value:"AZ"},types:[{label:"Physical",value:"physical"}]}],advancedSelection:[{label:"getFormValues 1",value:"getFormValues option 1"},{label:"getFormValues 2",value:"getFormValues option 2"},{label:"getFormValues 3",value:"getFormValues option 3"},{label:"getFormValues 4",value:"getFormValues option 4"}],mapCoordinates:{lat:48.858384,lng:2.294567},upload:[{id:"_OD_0354_c78fbb66-c75a-4804-9430-9af38ed8e9d5.jpg",name:"_OD_0354_c78fbb66-c75a-4804-9430-9af38ed8e9d5.jpg",size:499318,thumbnailUrl:"",fileUrl:""}],textEditor:"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas sit amet augue augue.",numberTable:j},l=({showState:i,onBack:u,prepopulate:o,prepopulateDuration:b,showSave:g,showCancel:h,required:e,disabled:n,showSections:d,collapsed:s,containerHeight:x,skeleton:L})=>{const S=G(),{state:p,methods:k,handleSubmit:v}=S,{reset:f}=k;a.useEffect(()=>(document.body.style.margin="0px",()=>{document.body.style.margin=z}),[]);const C=async({file:t,onChunkComplete:E,onUploadComplete:D})=>{for(let c=0;c<10;c++)await new Promise(I=>setTimeout(()=>I(E({percent:(c+1)*.1})),300));await D({id:P(),name:t.name,size:t.size,thumbnailUrl:["image/gif","image/jpeg","image/png"].includes(t.type)?URL.createObjectURL(t):"",fileUrl:URL.createObjectURL(t)})},A=async({id:t})=>{alert("DELETED FILE: "+t)},R=a.useMemo(()=>[{name:"textField",label:"Simple Text",type:"text",disabled:n,required:e},{name:"check",label:"Checkbox",type:"checkbox",disabled:n,required:e,inputSettings:{options:r}},{name:"chipSelect",label:"Chip single select",type:"chip",inputSettings:{options:[{label:"Label 1",value:"label_1"},{label:"Label 2",value:"label_2"},{label:"Very long label that should fit: Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat",value:"label_3"}]},disabled:n,required:e},{name:"dropdownSingle",label:"Dropdown single select",type:"dropdown",disabled:n,required:e,inputSettings:{options:[{label:"The Shawshank Redemption",value:"1994"},{label:"The Godfather",value:"1972"},{label:"The Godfather: Part II",value:"1974"},{label:"The Dark Knight",value:"2008"},{label:"12 Angry Men",value:"1957"},{label:"Schindler's List",value:"1993"},{label:"Pulp Fiction",value:"1994"},{label:"The Lord of the Rings: The Return of the King",value:"2003"},{label:"The Good, the Bad and the Ugly",value:"1966"},{label:"Fight Club",value:"1999"},{label:"The Lord of the Rings: The Fellowship of the Ring",value:"2001"},{label:"Star Wars: Episode V - The Empire Strikes Back",value:"1980"},{label:"Forrest Gump",value:"1994"},{label:"Inception",value:"2010"},{label:"The Lord of the Rings: The Two Towers",value:"2002"},{label:"One Flew Over the Cuckoo's Nest",value:"1975"},{label:"Goodfellas",value:"1990"},{label:"The Matrix",value:"1999"},{label:"Seven Samurai",value:"1954"},{label:"Star Wars: Episode IV - A New Hope",value:"1977"},{label:"City of God",value:"2002"},{label:"Se7en",value:"1995"}]}},{name:"phoneSelect",label:"Phone selection",type:"phone",disabled:n,required:e},{name:"radio",label:"Radio selection",type:"radio",disabled:n,required:e,inputSettings:{options:[{label:"Label 1",value:"label_1"},{label:"Label 2",value:"label_2"},{label:"Label 3",value:"label_3"}]}},{name:"toggle",label:"Toggle field",disabled:n,required:e,type:"toggle",inputSettings:{toggleLabel:"To the side"}},{name:"color",label:"Color selector example",disabled:n,required:e,type:"color"},{name:"date",label:"Single Date Picker",type:"date",disabled:n,required:e},{name:"time",label:"Single Time Picker",type:"time",disabled:n,required:e},{name:"address",label:"Address field",type:"address",inputSettings:{getOptionsCountries:M,getOptionsStates:U,googleMapsApiKey:"AIzaSyArV4f-KFF86Zn9VWAu9wS4hHlG1TXxqac"},disabled:n,required:e},{name:"advancedSelection",label:"Advanced Selection field",type:"advancedSelection",disabled:n,required:e,inputSettings:{options:r,createNewOption:Z}},{name:"textEditor",label:"Text Editor field",type:"textEditor",disabled:n,required:e},{name:"mapCoordinates",label:"Map Coordinates example",type:"mapCoordinates",disabled:n,required:e,inputSettings:{googleMapsApiKey:"AIzaSyArV4f-KFF86Zn9VWAu9wS4hHlG1TXxqac"}},{name:"upload",label:"Upload example",type:"upload",disabled:n,required:e,inputSettings:{onFileAdd:C,onFileDelete:A,limit:void 0}},{name:"numberTable",label:"Number Table",type:"numberTable",required:e,disabled:n,inputSettings:{rowTotalLabel:"TOTAL",columnTotalLabel:"No. Rooms",topLeftLabel:"Day",rows:B,columns:q}}],[n,e]),y=a.useMemo(()=>[{title:"Section 1",description:"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed et magna elit.",collapsed:s,fields:[[["textField"],["check"]],[["chipSelect"],["dropdownSingle"]],[["address"],[]],[["phoneSelect"],["radio"]]]},{title:"Section 2",description:"Vivamus facilisis dui id nunc ornare, eu pulvinar libero mattis. Fusce volutpat efficitur dui vitae egestas.",collapsed:s,fields:[[[],[],[]],[["toggle"],[],["mapCoordinates"]],[[]],[[],["advancedSelection"]]]},{title:"Section 3",description:"Phasellus egestas urna et ligula venenatis, at laoreet eros volutpat.",collapsed:s,fields:[[["color"],["date"],["time"]],[["textEditor"],[]]]}],[s]),_=a.useMemo(()=>y.slice(0,d),[y,d]),O=a.useCallback(async()=>{if(o)return await new Promise(t=>setTimeout(t,b*1e3)),{...X}},[o,b]),V=a.useMemo(()=>[{name:"reset",label:"Reset",onClick:()=>f(),color:"gray",variant:"outlined",show:!p.loadingInitial},...K(v,{showCancel:h,showSave:g})],[v,f,h,g,p.loadingInitial]);return m.jsxs("div",{style:{boxShadow:"0 1px 2px 0 rgb(0 0 0 / 0.05)",height:x},children:[i&&m.jsx("pre",{"data-testId":H.FORM_STATE,children:JSON.stringify(p,null,"  ")}),m.jsx(N,{...S,title:"Form Title",onBack:u?()=>alert("Cancelling, going back to previous site"):void 0,description:"Suspendisse condimentum iaculis velit id vestibulum.",fields:R,getFormValues:O,sections:d>0?_:void 0,buttons:V,skeleton:L})]})};l.args={showState:!1,onBack:!1,prepopulate:!1,prepopulateDuration:2,showSave:!0,showCancel:!0,required:!0,disabled:!1,showSections:0,collapsed:!1,containerHeight:"100vh",skeleton:!1};l.argTypes={showState:{name:"Show state"},onBack:{name:"Show Back Button"},prepopulate:{name:"Prepopulate"},prepopulateDuration:{name:"Prepopulate Duration"},showSave:{name:"Show Save Button"},showCancel:{name:"Show Cancel Button"},required:{name:"Required"},disabled:{name:"Disabled",description:"This disabled propery is passed down to the individual fields and does not represent the disabled property on the form state."},showSections:{name:"Show Sections"},collapsed:{name:"Collapsed"},containerHeight:{name:"Container Height"},skeleton:{name:"Skeleton"}};var w,T,F;l.parameters={...l.parameters,docs:{...(w=l.parameters)==null?void 0:w.docs,source:{originalSource:`({
  showState,
  onBack,
  prepopulate,
  prepopulateDuration,
...
}`,...(F=(T=l.parameters)==null?void 0:T.docs)==null?void 0:F.source}}};const J=["Playground"],oe=Object.freeze(Object.defineProperty({__proto__:null,Playground:l,__namedExportsOrder:J,default:W},Symbol.toStringTag,{value:"Module"}));export{oe as s};
