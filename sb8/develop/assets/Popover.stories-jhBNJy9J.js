import{r as I,j as e}from"./jsx-runtime-EKYJJIwR.js";import{r as n,g as _}from"./index-D0AnReJb.js";import{s as a}from"./styled-components.browser.esm-njFAddlw.js";import{t}from"./sizes-xhpoGYFi.js";import{s as C}from"./styled-components.browser.esm-D9jdcGim.js";import{P as A,a as R}from"./Popper-C2xxNeyp.js";import{G as H,B as f}from"./Button-B-HROxGS.js";import{C as W}from"./ClickAwayListener-Dv_hDxFo.js";import{A as q}from"./Add-BJ5QuHLi.js";import{r as z}from"./styled-Cb9FMILg.js";import{r as G}from"./createSvgIcon-DtczVsqP.js";import{G as D}from"./Grid-g7T_0i7W.js";const N=C(A)`
	&.MuiPaper-root {
...
`,$=a.span`
    ...
    font-size: 12px;
`,ne=e.jsxs("div",{children:[e.jsx(O,{children:"Title"}),e.jsx($,{children:"Subtitle"})]}),L=e.jsx("div",{style:{display:"flex",justifyContent:"center"},children:e.jsx(f,{intent:"info",variant:"text",label:"Add",mIcon:q,onClick:()=>alert("Add button clicked")})}),m=()=>{const[r,l]=n.useState(null),[i,o]=n.useState(!1),s=d=>{l(d.currentTarget),o(!0)},c=()=>{o(!1)},p=d=>{if(!d)return;const v=d.parentElement;v.scrollTop=d.clientHeight/4};return e.jsx(Z,{children:e.jsx(ee,{children:e.jsx(te,{container:!0,ref:p,children:e.jsxs("div",{children:[e.jsx(f,{intent:"primary",variant:"contained",label:"Open Popover",onClick:s}),e.jsx(b,{anchorEl:r,topContent:ne,bottomContent:L,onClose:c,open:i})]})})})})},oe=a.input`
    background-color: ${t.newColors.grey1[100]};
...
}`,...(y=(w=m.parameters)==null?void 0:w.docs)==null?void 0:y.source}}};var j,k,S;h.parameters={...h.parameters,docs:{...(j=h.parameters)==null?void 0:j.docs,source:{originalSource:`(): ReactElement => {
  const [anchorEl, setAnchorEl] = useState<HTMLButtonElement | null>(null);
  const [open, setOpen] = useState(false);
  const handleClick = (event: MouseEvent<HTMLButtonElement>) => {
    setAnchorEl(event.currentTarget);
