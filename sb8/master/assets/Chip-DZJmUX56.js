...
`;function $o({$selected:o,disabled:a,onClick:i}){return o?a?{base:n.newColors.simplyGold[60]}:{base:n.newColors.simplyGold[100],focus:i&&n.newColors.darkerSimplyGold[100],hover:i&&n.newColors.darkerSimplyGold[100]}:{base:n.newColors.grey2[100],focus:i&&n.newColors.simplyGrey[100],hover:i&&n.newColors.simplyGrey[100]}}const yo=E(w)`
	&.MuiChip-root {
		max-width: 186px;
		color: ${n.newColors.almostBlack[100]};
		padding: 8px 16px;
		...
		${({$selected:o,disabled:a,onClick:i})=>{const{base:e,focus:t,hover:d}=$o({$selected:o,disabled:a,onClick:i});return`
				background-color: ${e};
...
`,Po=o=>{const{label:a,disabled:i,selected:e,onDelete:t,onClick:d}=o,s=v.useRef();return t?g.jsx(go,{...o,color:"default",children:o.children,title:typeof a=="string"?a:void 0,ref:s,disabled:i,deleteIcon:g.jsx(B,{"data-testid":"delete-icon-test-id"}),onDelete:t,"data-testid":"delete-chip-testid"}):g.jsx(yo,{...o,color:"default",children:o.children,title:typeof a=="string"?a:void 0,ref:s,disabled:i,$selected:e,"aria-selected":e,onClick:d,"data-testid":"chip-testid"})};export{Po as C,w as a,B as d};
