import{r as i,R as g}from"./index-ePW8zFKp.js";import{s as p,c as u}from"./styled-components.browser.esm-CUKKF2J4.js";import{t as f}from"./testIds-B6Pox1zA.js";import{D as v}from"./scrollbarStyles-CVTIwy1f.js";import{B as k}from"./Popper-Bt--aTPm.js";function A(t,e){if(t.length===0)return[];const r=t[t.length-1];return t.map((n,s)=>{const o=s===t.length-1,l=s===t.length-2;return o&&n===!1&&e?"closing":o&&n===!0&&e?"opening":o&&n===!0?"open":l&&r===!0&&e?"stacking":l&&r===!1&&e?"unstacking":"stacked"})}const c=250,E=u`
	from {
	  	right: -75vw;
	}
	to {
