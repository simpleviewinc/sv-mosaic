import{j as i}from"./jsx-runtime-nGUw9YhZ.js";import{P as c}from"./PageHeader-B-ax13VL.js";import{o}from"./storyUtils-BoiXCagy.js";const u={title:"Components/PageHeader"},e=({title:r,showButtons:l,showBack:s})=>i.jsx(c,{title:r,buttons:l?[{label:"Cancel",onClick:o,color:"gray",variant:"outlined"},{label:"Save",onClick:()=>alert("Saving"),color:"yellow",variant:"contained"}]:void 0,onBack:s?o:void 0});e.args={title:"Playground page",showButtons:!0,showBack:!0};e.argTypes={title:{name:"Title"},showButtons:{name:"Show Primary Actions"},showBack:{name:"Show Back Button"}};var n,a,t;e.parameters={...e.parameters,docs:{...(n=e.parameters)==null?void 0:n.docs,source:{originalSource:`({
  title,
  showButtons,
  showBack
