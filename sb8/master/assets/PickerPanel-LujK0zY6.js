...
`;function ye({fullHeight:n=!0,className:l,options:o,checked:d,disabled:M,optionsSubtitle:h,activePanel:O,onLoadMore:v,onChange:P,onKeywordChange:x,onSave:m,onCancel:u,onCreateNew:E,isLoading:b,noOptions:z="No options to display",saveText:_="Save",...p}){const[i,B]=g.useState(""),{t:f}=J(),S=g.useMemo(()=>i?o.filter(t=>t.label.toLowerCase().includes(i.toLowerCase())):o,[i,o]),T=t=>{P&&P(t)},k=g.useMemo(()=>{const t=[];return!m&&!u||(u&&t.push({label:"Cancel",onClick:u,intent:"secondary",variant:"contained"}),m&&t.push({label:_,onClick:()=>m(d),intent:"primary",variant:"contained"})),t},[d,u,m,_]),D=({target:{value:t}})=>{B(t),x&&x(t)};return e.createElement(ee,{$fullHeight:n,className:l},(p.title||k.length||p.onBack)&&e.createElement(F,{...p,buttons:k}),e.createElement(te,null,e.createElement(ae,{"data-testid":V.PICKER_PANEL_OPTIONS},e.createElement(re,null,h&&e.createElement(oe,null,h),e.createElement(ie,{fieldSize:"100%",onChange:D,value:i,placeholder:f("mosaic:common.keyword___"),autoFocus:!0,InputProps:{inputProps:{"aria-label":f("mosaic:common.keyword___")},startAdornment:e.createElement(y,{position:"start"},e.createElement(U,null)),endAdornment:E&&i&&e.createElement(y,{position:"end"},e.createElement(L,{label:"Create",variant:"text",intent:"secondary",mIcon:Z,onClick:()=>E(i)}))}})),e.createElement(ne,null,S.length?e.createElement(K,{checked:d,options:S,onChange:T,itemsPerColumn:-1,disabled:M}):e.createElement(e.Fragment,null,z),b&&e.createElement(j,{$justify:"center"},e.createElement(se,null)),!b&&v&&e.createElement(le,{intent:"secondary",variant:"contained",label:f("mosaic:common.load_more___"),onClick:v}))),O))}export{Z as A,ye as P,U as S,ke as a,oe as b};
