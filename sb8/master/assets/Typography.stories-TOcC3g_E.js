import{j as e}from"./jsx-runtime-EKYJJIwR.js";import{t as s}from"./sizes-BklZZmo4.js";import{R as B}from"./index-D0AnReJb.js";import{T as b}from"./Typography-iddL5eaH.js";import{T as c}from"./TitleText-CICG0G5h.js";import{S as H}from"./SubtitleText-DS-qVyZH.js";import{s as i}from"./styled-components.browser.esm-njFAddlw.js";const a=l=>B.createElement(b,{...l,variant:"body"}),v=["a","div","h1","h2","h3","h4","h5","h6","p","pre","small","span","strong","sub","sup"],M={title:"Components/Typography"},o="Lorem ipsum dolor sit amet, consectetur adipiscing elit. In lobortis, nulla et iaculis semper, turpis massa faucibus sem, et egestas purus leo ut mauris. Nam ac ex porttitor, tempus eros eu, rhoncus libero. Integer risus lacus, ultrices at turpis id, suscipit vulputate nulla. Cras tincidunt ante quis mi accumsan.",m=o.substring(0,93),d="https://www.google.com/?q=46503807498226023045874012183575071093022671901587285495525521941359381308429902926377654197863336467166861936857990937433143015269066983394795324415786553093224671668619368579909374331430152690669833947",_=["title","subtitle","body"],A=["black","blue","lightBlue","red","yellow","teal","gray","white"],C=["-moz-initial","-moz-pre-wrap","break-spaces","inherit","initial","normal","nowrap","pre","pre-line","pre-wrap","revert","revert-layer"],R=i.div`
...
`;function t({variant:l,tag:f,maxLines:w,whiteSpace:T,breakAll:S,title:j,children:k,color:L}){return e.jsx(b,{variant:l,tag:f,maxLines:w,whiteSpace:T,breakAll:S,title:j,children:k,color:L})}t.args={variant:"title",tag:"div",maxLines:0,whiteSpace:"normal",breakAll:!1,title:"",children:"Lorem ipsum",color:"black"};t.argTypes={variant:{name:"Variant",control:{type:"select"},options:_},tag:{name:"Tag",control:{type:"select"},options:v},maxLines:{name:"Maximum Lines"},whiteSpace:{name:"White Space Style",control:{type:"select"},options:C},breakAll:{name:"Break All Style"},title:{name:"Title"},children:{name:"Children"},color:{name:"Colour",control:{type:"select"},options:A}};function r(){return e.jsxs(e.Fragment,{children:[e.jsx(R,{children:e.jsxs(z,{children:[e.jsx(n,{children:"Standard Title"}),e.jsx(c,{children:m}),e.jsx(n,{children:"Title rendered as a h2 element"}),e.jsx(c,{tag:"h2",children:m}),e.jsx(n,{children:"Title with a maximum number of lines"}),e.jsx(c,{children:o,maxLines:1}),e.jsx(n,{children:"Subtitle"}),e.jsx(H,{children:m}),e.jsx(n,{children:"Body"}),e.jsx(a,{children:o}),e.jsx(n,{children:"Body with an alternate colour and a maximum number of lines"}),e.jsx(a,{children:o,maxLines:2,color:"red"}),e.jsx(n,{children:"Body with a maximum number of lines and breakable characters"}),e.jsx(a,{children:d,maxLines:1,breakAll:!0}),e.jsx(n,{children:"Body with custom styling"}),e.jsx(E,{children:d,maxLines:1,breakAll:!0})]})}),e.jsx("style",{dangerouslySetInnerHTML:{__html:".sb-show-main{margin: 0}"}})]})}var p,h,u;t.parameters={...t.parameters,docs:{...(p=t.parameters)==null?void 0:p.docs,source:{originalSource:`function Playground({
  variant,
  tag,
  maxLines,
  whiteSpace,
...
}`,...(y=(g=r.parameters)==null?void 0:g.docs)==null?void 0:y.source}}};const P=["Playground","KitchenSink"],U=Object.freeze(Object.defineProperty({__proto__:null,KitchenSink:r,Playground:t,__namedExportsOrder:P,default:M},Symbol.toStringTag,{value:"Module"}));export{U as s};
