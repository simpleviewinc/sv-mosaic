import{j as t}from"./jsx-runtime-D_zvdyIk.js";import{r as d}from"./index-wekxHvEx.js";import{u as k,F as j,n as P}from"./index-Be0ln9Sk.js";import{r as J}from"./renderButtons-DP0bGf4C.js";import{c as B}from"./commonFieldControl-LQDYMh-C.js";import{m}from"./options-DEOzrsxm.js";import{J as K,c as L,M as E}from"./MultiSelectHelper-DdPpG7Dh.js";const Q={title:"FormFields/FormFieldAdvancedSelection"},n=({label:i,hideLabel:g,required:O,prepop:o,prepopData:a,disabled:s,instructionText:w,forceInstructionTooltip:b,helperText:r,optionsType:l,createNewOptionsKnob:e,selectLimit:y,itemsPerLoad:S,totalAvailableOptions:h})=>{const f=k({data:o?a:{}}),{state:I,handleSubmit:R}=f,[N,q]=d.useState(m),{categoriesApi:A,categoriesHelper:D}=d.useMemo(()=>{const c=new K(h>-1?L.slice(0,h):L),v=new E({api:c,labelColumn:"tag",valueColumn:"id",sortColumn:"sort_tag"});return{categoriesApi:c,categoriesHelper:v}},[h]),F=d.useCallback(async c=>{const v=P(),p={_id:v,tag:c,sort_tag:c,updated:new Date,created:new Date,id:v};q(G=>[...G,{label:p.tag,value:p.id}]);const V=[...await A.getData(),p];return await A.setData(V),{label:p.tag,value:p.id}},[A]),z=d.useMemo(()=>[{name:"advancedSelection",label:i,hideLabel:g,required:O,disabled:s,helperText:r,instructionText:w,forceInstructionTooltip:b,type:"advancedSelection",inputSettings:{...l==="Synchronous"?{options:N}:{getOptions:D.getOptions.bind(D),getOptionsLimit:S},createNewOption:e?F:void 0,selectLimit:y}}],[i,g,O,s,r,w,b,l,N,D,S,e,F,y]);return t.jsxs(t.Fragment,{children:[t.jsx("pre",{children:JSON.stringify(I,null,"  ")}),t.jsx(j,{...f,buttons:J(R),title:"Advanced Selection Field",fields:z})]})};n.args={...B.args({prepopData:{advancedSelection:m.slice(0,3)}}),optionsType:"Synchronous",createNewOptionsKnob:!0,selectLimit:-1,itemsPerLoad:5,totalAvailableOptions:-1};n.argTypes={...B.argTypes,optionsType:{name:"Options Type",options:["Synchronous","Asynchronous"],control:{type:"select"}},createNewOptionsKnob:{name:"Create New Option"},selectLimit:{name:"Select Limit"},itemsPerLoad:{name:"Items Per Load"},totalAvailableOptions:{name:"Total Available Options"}};const u=()=>{const i=k(),{state:g,handleSubmit:O}=i,o=m?m:[],a=new K(L),s=new E({api:a,labelColumn:"tag",valueColumn:"id",sortColumn:"sort_tag"}),w=async r=>{const l=P(),e={_id:l,tag:r,sort_tag:r,updated:new Date,created:new Date,id:l};m.push({label:e.tag,value:e.id});const S=[...await a.getData(),e];return await a.setData(S),{label:e.tag,value:e.id}},b=d.useMemo(()=>[{name:"checkboxOptions",label:"Advanced selection with options prop",type:"advancedSelection",inputSettings:{options:o}},{name:"getOptions",label:"Advanced selection with getOptions prop",type:"advancedSelection",inputSettings:{getOptions:s.getOptions.bind(s),getOptionsLimit:5}},{name:"createNewOption",label:"Advanced selection with createNewOption prop",type:"advancedSelection",inputSettings:{options:o,getOptionsLimit:10,createNewOption:w}},{name:"selectLimitOfOptions",label:"Advanced selection with selectLimit prop (Max 2 options)",type:"advancedSelection",inputSettings:{options:o,getOptionsLimit:10,selectLimit:2}}],[o]);return t.jsxs(t.Fragment,{children:[t.jsx("pre",{children:JSON.stringify(g,null,"  ")}),t.jsx(j,{...i,buttons:J(O),title:"Form Title",description:"Description",fields:b})]})};var x,_,T;n.parameters={...n.parameters,docs:{...(x=n.parameters)==null?void 0:x.docs,source:{originalSource:`({
  label,
  hideLabel,
  required,
  prepop,
...
}`,...(M=(H=u.parameters)==null?void 0:H.docs)==null?void 0:M.source}}};const U=["Playground","KitchenSink"],oe=Object.freeze(Object.defineProperty({__proto__:null,KitchenSink:u,Playground:n,__namedExportsOrder:U,default:Q},Symbol.toStringTag,{value:"Module"}));export{oe as s};
