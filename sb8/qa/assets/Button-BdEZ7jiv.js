...
`),De={danger:{contained:`
	...
	&& {
		...
		${({$inherit:e,$size:o="sm"})=>`
			font-size: ${e?"1em":a.fontSize.icon[o]};
		`}
...
`,Eo=B.div`
	...
	position: absolute;
`,So=[{name:"offset",options:{offset:[0,10]}}],ko=e=>{const{children:o,open:n,placement:t="bottom-start",anchorEl:i,id:l,maxWidth:s}=e,d=c.useMemo(()=>({maxWidth:s}),[s]);return c.createElement(Io,{open:n,anchorEl:i,placement:t,modifiers:So,role:"tooltip",id:l,"data-testid":"tooltip-test-id",style:d},c.createElement(Eo,{className:"arrow"}),o)};function Po(){const[e,o]=c.useState(null),[n,t]=c.useState(!1),i=c.useId(),l=c.useMemo(()=>({open:n,anchorEl:e,id:`tooltip-${i}`}),[n,e,i]),s=c.useMemo(()=>({ref:o,onMouseEnter:()=>t(!0),onMouseLeave:()=>t(!1),"aria-describedby":`tooltip-${i}`}),[i]);return{tooltipProps:l,anchorProps:s}}function J(e,o=!0){const n=c.useRef(!1);c.useEffect(()=>{n.current||!o||(console.warn(e),n.current=!0)})}const Bo=c.createContext(null),Ro={anchorOrigin:{vertical:"bottom",horizontal:"left"},transformOrigin:{vertical:"top",horizontal:"left"}},zo={black:"specialized",blue:"info",gray:"secondary",lightBlue:"secondary",red:"danger",teal:"info",white:"secondary",yellow:"primary"},ve=c.forwardRef(function({size:o="medium",alignItems:n="center",...t},i){var l,s;const d=t.mIcon,u=!t.label&&d,b=t.iconPosition||"left",h=d&&w.createElement(Ve,{as:d,style:{color:t.mIconColor},$isAdornment:!u,$inherit:o==="inherit",$size:u?"md":"sm"}),p=ee(t,"disabled",!1);J("[MOS Button] The `color` prop is deprecated and should no longer be used, it will be removed in a future version. Use the `intent` prop instead.",t.color!==void 0),J("[MOS Button] The `icon` variant is deprecated. Mosaic now infers an icon variant from the use of the `mIcon` prop and the lack of a `label` prop.",t.variant==="icon"),J("[MOS Button] The `outlined` variant is deprecated and should no longer be used, it will be removed in a future version. Use either `contained` or `text`",t.variant==="outlined");const f=(s=(l=t.intent)!==null&&l!==void 0?l:zo[t.color])!==null&&s!==void 0?s:"secondary",g={$variant:t.variant,$intent:f,$bluntLeft:t.bluntLeft,$bluntRight:t.bluntRight,disabled:t.invisible||p,size:o,$size:o,onClick:t.onClick,onBlur:t.onBlur,href:t.href,name:t.name,id:t.id,type:t.type||"button",as:t.as,ref:i,disableRipple:!0,"aria-label":typeof t.label=="string"?t.label:typeof t.tooltip=="string"?t.tooltip:void 0,...t.muiAttrs},E=["button",t.className,t.variant==="icon"?"iconButton":"normalButton",t.fullWidth&&"fullWidth",t.invisible&&"invisible",`size_${o}`,`variant_${t.variant}`].filter(Boolean).join(" ");return w.createElement(Oe,{...t.attrs,$fullWidth:t.fullWidth,className:E,onMouseEnter:t.onMouseEnter,onMouseLeave:t.onMouseLeave},w.createElement(Ae,{...g,$fullWidth:t.fullWidth,$isIconButton:u,$alignItems:n},w.createElement(He,null),w.createElement(Ge,{$size:o},b==="left"&&h,t.label&&(typeof t.label=="string"?w.createElement(Ue,null,t.label):t.label),b==="right"&&h)))});function Lo(e){const{anchorProps:o,tooltipProps:n}=Po(),[t,i]=c.useState(null);function l(f){i(f.currentTarget)}function s(){i(null)}const d=f=>{l(f),e.onClick&&e.onClick(f)},u=e.popoverEvent==="onHover",b=f=>{e.onMouseEnter&&e.onMouseEnter(f),e.popover&&u&&l(f),o.onMouseEnter()},h=f=>{e.onMouseLeave&&e.onMouseLeave(f),e.popover&&u&&s(),o.onMouseLeave()},p=ee(e.menuItems||[],"show",!0);return e.menuItems&&!p.length?null:w.createElement(w.Fragment,null,w.createElement(ve,{...e,onClick:d,onMouseEnter:b,onMouseLeave:h,ref:o.ref}),e.tooltip&&w.createElement(ko,{...n},e.tooltip),e.popover?w.createElement(pe,{open:!!t,anchorEl:t,onClose:s,disableRestoreFocus:!0,style:u?{pointerEvents:"none"}:null,...Ro},w.createElement(Bo.Provider,{value:{onClose:s}},e.popover)):e.menuItems?w.createElement(wo,{items:p,onChange:e.menuOnChange,value:e.menuValue,anchorEl:t,open:!!t,onClose:s}):null)}function To(e){return ee(e,"show")?e.menuItems||e.popover||e.tooltip?w.createElement(Lo,{...e}):w.createElement(ve,{...e}):null}const qo=c.memo(To);export{qo as B,wo as M,ko as T,Mo as a,po as b,Ne as c,bo as d,Bo as e,Po as u};
