...
`),Go=Q(Oo)(({$color:e,$variant:o,$size:t,$fullWidth:n,disabled:a})=>{const i=Je(e,o);return`
		&& {
			...
			padding: ${Ho(o,t)};
			width: ${n?"100%":"auto"};
			text-transform: ${o==="text"||o==="input"?"none":"uppercase"};
			line-height: 1.75;
			cursor: pointer;
