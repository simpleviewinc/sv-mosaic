import{r as f,R as m}from"./index-CDlOlYQx.js";import{C as S}from"./Checkbox-DXOuBkLC.js";import{C as b,t as x}from"./sizes-BeWafy6f.js";import{c as B}from"./containerQuery-DwQ6QvMu.js";import{c as h}from"./styled-components.browser.esm-CsHOGV45.js";import{C as N}from"./StyledPopperPaper-CblYxRKp.js";import"./TooltipIcon-if6WdNgf.js";import{F as T}from"./FormGroup-DqpNDYHy.js";function w(a,r,e=t=>t){const t=[];for(const o of a)r.some(s=>e(o)===e(s))||t.push(o);for(const o of r)a.some(s=>e(o)===e(s))||t.push(o);return t}function g(a,r){if(r<1)throw new Error(`Chunk size should be more than 0, provided ${r}`);const e=[],t=Math.ceil(a.length/r);for(let o=0;o<r;o++){const s=a.slice(o*t,(o+1)*t);if(!s.length)return e;e.push(s)}return e}const F=h(T)`
