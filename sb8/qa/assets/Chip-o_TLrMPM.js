...
`,Oo=o=>{const{label:a,disabled:i,selected:e=!1,onDelete:t,onClick:d}=o,s=v.useRef();return t?b.jsx(bo,{...o,color:"default",children:o.children,title:typeof a=="string"?a:void 0,ref:s,disabled:i,deleteIcon:b.jsx(B,{"data-testid":"delete-icon-test-id"}),onDelete:t,"data-testid":"delete-chip-testid"}):b.jsx($o,{...o,color:"default",children:o.children,title:typeof a=="string"?a:void 0,ref:s,disabled:i,$selected:e,"aria-selected":e,onClick:d,"data-testid":"chip-testid"})};export{Oo as C,w as a,B as d};
