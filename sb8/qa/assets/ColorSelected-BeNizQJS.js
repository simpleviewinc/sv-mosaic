...
`;function wc(e){const t=c.useCallback(function(a){e.onLimitChange({limit:Number(a)})},[e.onLimitChange]),n=c.useMemo(function(){return e.options.map(a=>({label:a.toString(),value:a.toString()}))},[e.options]),r=d.jsx(Xt,{options:n,onChange:t,value:e.limit.toString()});return d.jsx(bc,{color:"black",label:e.limit.toString(),variant:"text",size:"small",iconPosition:"right",mIcon:Lt,mIconColor:M.newColors.almostBlack[100],menuContent:r})}const xc=c.memo(wc),Cc=E.div`
	font-size: 14px;
	display: inline-flex;
	align-items: center;
...
`,Hc=E.div`
  ...
  width: 80px;
`,wu=E(fa)`
`,xu=e=>{const{disabled:t,color:n,onClick:r,displayColorPicker:a,id:i}=e;return d.jsx(Yc,{$disabled:t,$displayColorPicker:a,onClick:r,type:"button",id:i,children:d.jsx(Hc,{"data-testid":"colordiv-test",$disabled:t,$color:n})})};export{Wt as A,gu as B,xu as C,oc as D,wu as P,Wi as _,bu as a,Ra as b,Pi as c,pe as d,Aa as e,vu as f,Fa as g,Dt as h,qn as i,mt as j,La as k,$a as l,mu as m,za as n,Oa as o,Ri as p,qa as q,Y as r,vt as s,ce as t,Tn as u,Ha as v,j as w,Ma as x,Xl as y,Vt as z};
