...
`,gc=M.span`
	font-weight: 400;
`,vc={"aria-label":"Previous Page"},bc={"aria-label":"Next Page"};function wc(e){const{t}=Ne(),n=Math.ceil(e.count/e.limit),r=(e.skip+e.limit)/e.limit,a=e.skip+1,i=Math.min(e.skip+e.limit,e.count),o=u=>()=>{e.onSkipChange({skip:u})},s=r===1,l=r===n;return n===0?null:d.jsxs(mc,{"data-testid":W.DATA_VIEW_PAGER,children:[d.jsx(Y,{color:"black",variant:"text",size:"small",tooltip:t("mosaic:DataView.jump_to_page"),label:d.jsxs("span",{children:[a,"-",i," ",d.jsx(gc,{children:"of"})," ",e.count]}),popover:d.jsx(hc,{currentPage:r,totalPages:n,limit:e.limit,onSkipChange:e.onSkipChange})}),d.jsx(Hn,{color:"gray",variant:"icon",size:"small",mIcon:ha,onClick:o(e.skip-e.limit),disabled:s,muiAttrs:vc}),d.jsx(Hn,{color:"gray",variant:"icon",size:"small",mIcon:Da,onClick:o(e.skip+e.limit),disabled:l,muiAttrs:bc})]})}const xc=c.memo(wc),Cc=M.div`
	align-items: center;
	display: flex;
	justify-content: space-between;
`,yc=M.div`
