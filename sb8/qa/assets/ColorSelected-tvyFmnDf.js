...
`,ln=c.forwardRef(({checked:e,onReorder:t,disabled:n,onCheckboxClick:r,hasActions:a,primaryActions:i,additionalActions:o,actionsHidden:s,originalRowData:l,columns:u,row:f,isDragOverlay:h,style:m,...g},y)=>d.jsxs(Il,{style:m,className:e&&"checked",ref:y,$isDragOverlay:h,children:[t&&d.jsx(ft,{children:d.jsx(z,{disabled:n,color:"black",variant:"icon",mIcon:sn,muiAttrs:{...g},component:Nl})},"_draggable"),r&&d.jsx(ft,{children:d.jsx(yt,{checked:e===!0,onClick:r,disabled:n})},"_bulk"),a&&d.jsx(ft,{children:d.jsx($r,{primaryActions:i,additionalActions:o,actionsHidden:s,disabled:n,originalRowData:l,activeDisplay:"list"})}),u.map(v=>d.jsx(ft,{ariaLabel:v.label,expandCell:!0,bold:v.style&&v.style.bold,italic:v.style&&v.style.italic,strikeThrough:v.style&&v.style.strikeThrough,noWrap:v.style&&v.style.noWrap,ellipsis:v.style&&v.style.ellipsis,maxWidth:v.style&&v.style.maxWidth,textTransform:v.style&&v.style.textTransform,children:f[v.name]},v.name))]}));ln.displayName="DataViewTrStatic";function Ll(e){const{attributes:t,listeners:n,setNodeRef:r,transform:a,transition:i,isDragging:o}=Rr({id:e.originalRowData.id}),s={transform:Pe.Translate.toString(a),transition:i};return d.jsx(ln,{...e,...t,...n,ref:r,style:s,isDragOverlay:o})}function Bl(e){return e.onReorder?d.jsx(Ll,{...e}):d.jsx(ln,{...e})}const Wl=E.tbody`
	& > tr {
...
`,_r=c.forwardRef((e,t)=>d.jsx(Wl,{ref:t,children:e.transformedData.map((n,r)=>{var a,i,o,s;return d.jsx(Bl,{row:n,originalRowData:e.data[r],primaryActions:(i=(a=e.rowActions)==null?void 0:a[n.id])==null?void 0:i.primary,additionalActions:(s=(o=e.rowActions)==null?void 0:o[n.id])==null?void 0:s.additional,actionsHidden:e.actionsHidden,disabled:e.disabled,onCheckboxClick:e.onCheckboxClick?()=>e.onCheckboxClick(r):void 0,checked:e.checked?e.checked[r]:!1,columns:e.columns,onReorder:e.onReorder,hasActions:e.hasActions},n.id)})}));_r.displayName="DataViewTBody";const Fl=c.memo(_r);function Vl(e,t){let n=e[t.column||t.name];if(n!==void 0&&t.transforms!==void 0)for(const r of t.transforms)n!==void 0&&(n=r({data:n,row:e}));return n}function Ir(e,t){return e.map(r=>{const a={...r};return t.forEach(i=>{a[i.name]=Vl(r,i)}),a})}function zl(e,t,n){const r={...e};return t.top+e.y<=n.top?r.y=n.top-t.top:t.bottom+e.y>=n.top+n.height&&(r.y=n.top+n.height-t.bottom),t.left+e.x<=n.left?r.x=n.left-t.left:t.right+e.x>=n.left+n.width&&(r.x=n.left+n.width-t.right),r}function Ul(e){return e.reduce((t,n)=>t+n,0)}const Yl=E.table`
	width: 100%;
	border-collapse: collapse;
`;function Hl(e){const t=c.useRef(),{rowActions:n}=e,r=c.useMemo(()=>Ir(e.data,e.activeColumnObjs),[e.data,e.activeColumnObjs]),a=Ul(Object.entries(n).map(([,{primary:l=[],additional:u=[]}])=>l.length+u.length))>0,i=nr(wt(Tt),wt(St,{coordinateGetter:Ar}));function o(l){const{active:u,over:f}=l;if(u.id!==f.id){const h=e.data.map(({id:m})=>String(m));e.onReorder(Mt(h,h.indexOf(u.id),h.indexOf(f.id)))}}const s=c.useCallback(({draggingNodeRect:l,transform:u})=>{if(!l||!t.current)return u;const f=t.current.getBoundingClientRect();return f?zl(u,l,f):u},[]);return d.jsx(xr,{sensors:i,collisionDetection:or,onDragEnd:o,autoScroll:{layoutShiftCompensation:!1},modifiers:[Cr,s],children:d.jsx(Sr,{items:r.map(l=>l.id),strategy:kr,children:d.jsxs(Yl,{children:[d.jsx(Al,{checked:e.checked,checkedAllPages:e.checkedAllPages,columns:e.activeColumnObjs,allColumns:e.columns,data:e.data,bulkActions:e.bulkActions,sort:e.sort,count:e.count,rowCount:e.rowCount,onSortChange:e.onSortChange,onCheckAllClick:e.onCheckAllClick,onCheckAllPagesClick:e.onCheckAllPagesClick,onColumnsChange:e.onColumnsChange,onReorder:e==null?void 0:e.onReorder,allChecked:e.allChecked,anyChecked:e.anyChecked,showBulkAll:e.showBulkAll,hasActions:a,disabled:e.disabled}),d.jsx(Fl,{checked:e.checked,columns:e.activeColumnObjs,data:e.data,hasActions:a,transformedData:r,bulkActions:e.bulkActions,actionsHidden:e.actionsHidden,disabled:e.disabled,rowActions:n,onCheckboxClick:e.onCheckboxClick,onReorder:e.onReorder,ref:t})]})})})}const ql=Ht.topComponent.bigScreenView+"px",Xl=Ht.topComponent.responsiveView+"px",Gl=Ht.mobile+"px",Kl=E.div`
	& > .topRowBulkAll {
		margin-bottom: 5px;
	}
...
`;function dc(e){const n=e.displayOptions.find(i=>i.name===e.display).mIcon,r=e.displayOptions.map(i=>({value:i.name,label:i.label,mIcon:i.mIcon})),a=d.jsx(qt,{options:r,onChange:e.onDisplayChange,value:e.display});return d.jsx(uc,{children:d.jsx(z,{variant:"icon",color:"black",mIcon:n,iconPosition:"right",size:"small",menuContent:a})})}const fc=c.memo(dc),hc=E(z)`
	button {
		font-weight: 400;
	}
`;function gc(e){const t=c.useCallback(function(a){e.onLimitChange({limit:Number(a)})},[e.onLimitChange]),n=c.useMemo(function(){return e.options.map(a=>({label:a.toString(),value:a.toString()}))},[e.options]),r=d.jsx(qt,{options:n,onChange:t,value:e.limit.toString()});return d.jsx(hc,{color:"black",label:e.limit.toString(),variant:"text",size:"small",iconPosition:"right",mIcon:Lt,mIconColor:A.newColors.almostBlack[100],menuContent:r})}const mc=c.memo(gc),vc=E.div`
	font-size: 14px;
	display: inline-flex;
	align-items: center;
...
`,Cc=E.span`
	font-weight: 400;
`;function yc(e){const{t}=$e(),n=Math.ceil(e.count/e.limit),r=(e.skip+e.limit)/e.limit,a=e.skip+1,i=Math.min(e.skip+e.limit,e.count),o=u=>()=>{e.onSkipChange({skip:u})},s=r===1,l=r===n;return n===0?null:d.jsxs(xc,{children:[d.jsx(z,{color:"black",variant:"text",size:"small",tooltip:t("mosaic:DataView.jump_to_page"),label:d.jsxs("span",{children:[a,"-",i," ",d.jsx(Cc,{children:"of"})," ",e.count]}),popover:d.jsx(wc,{currentPage:r,totalPages:n,limit:e.limit,onSkipChange:e.onSkipChange})}),d.jsx(Vn,{color:"gray",variant:"icon",size:"small",mIcon:ba,onClick:o(e.skip-e.limit),disabled:s}),d.jsx(Vn,{color:"gray",variant:"icon",size:"small",mIcon:ya,onClick:o(e.skip+e.limit),disabled:l})]})}const kc=c.memo(yc),Dc=E.div`
	align-items: center;
	display: flex;
	justify-content: space-between;
`,pc=E.div`
...
`,Nc=E.div`
  ...
  width: 80px;
`,uu=E(ma)`
`,du=e=>{const{disabled:t,color:n,onClick:r,displayColorPicker:a,id:i}=e;return d.jsx(Ic,{$disabled:t,$displayColorPicker:a,onClick:r,type:"button",id:i,children:d.jsx(Nc,{"data-testid":"colordiv-test",$disabled:t,$color:n})})};export{Ul as A,Wt as B,du as C,nc as D,uu as P,Vi as _,cu as a,Aa as b,Ii as c,De as d,Ea as e,lu as f,Ya as g,kt as h,Xn as i,gt as j,Fa as k,Na as l,su as m,Ua as n,Ga as o,Tn as p,Xa as q,Y as r,mt as s,ce as t,ja as u,Ai as v,P as w,Oa as x,Jn as y,Bt as z};
