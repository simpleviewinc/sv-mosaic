import{j as o}from"./jsx-runtime-CexXSJP5.js";import{r as u}from"./index-BP8_t0zE.js";import{D as g}from"./DataViewFilterMultiselect-BjUTseV3.js";import"./isSymbol-CEVJpixJ.js";import"./DataViewFilterMultiselectDropdownContent-BHz2sU_E.js";import"./Button-DMdypOK9.js";import"./useMosaicTranslation-DzvJLSut.js";import"./FormFieldText.styled-ThfS-v4H.js";import"./ButtonRow-Bf0hMbCe.js";import"./theme-CtvfJOCv.js";import"./Chip-C1CRxgK0.js";import"./Typography-v36okEvj.js";import"./CheckboxList-BCG88NR0.js";import"./Checkbox-DnFKua5S.js";import{M as f,J as b,c as y}from"./MultiSelectHelper-CTwUk70x.js";const x={title:"Components/DataViewFilterMultiselect"},w=new b(y),e=new f({api:w,labelColumn:"tag",valueColumn:"id",sortColumn:"sort_tag"}),i=({showComparisons:s,limit:c})=>{const[n,r]=u.useState({comparison:"in",value:[]}),p=function(a){if(a===void 0)return r({...n,comparison:"",value:[]});r({...n,comparison:a.comparison||n.comparison,value:a.value})},m=()=>{alert("on remove")};return o.jsx(o.Fragment,{children:o.jsx(g,{label:"Multi Select Category",args:{getOptions:e.getOptions.bind(e),getSelected:e.getSelected.bind(e),comparisons:s&&["in","not_in","all","exists","not_exists"],limit:c},data:n,onRemove:m,onChange:a=>p(a)},"multi_select_category")})};i.args={showComparisons:!1,limit:25};const l=()=>{const[s,c]=u.useState({comparison:"in",value:[]}),[n,r]=u.useState({comparison:"in",value:[]}),p=function(t){if(t===void 0)return c({...s,comparison:"",value:[]});c({...s,comparison:t.comparison||s.comparison,value:t.value})},m=function(t){if(t===void 0)return r({...n,comparison:"",value:[]});r({...n,comparison:t.comparison||n.comparison,value:t.value})},a=()=>{alert("on remove")};return o.jsxs(o.Fragment,{children:[o.jsx("h2",{children:"Hide comparison selector"}),o.jsx(g,{label:"Multi Select Category",args:{getOptions:e.getOptions.bind(e),getSelected:e.getSelected.bind(e)},data:s,onRemove:a,onChange:t=>p(t)},"multi_select_category"),o.jsx("h2",{children:"Show comparison selector"}),o.jsx(g,{label:"Multi Select Category With Comparisons",args:{getOptions:e.getOptions.bind(e),getSelected:e.getSelected.bind(e),comparisons:["in","not_in","all","exists","not_exists"]},data:n,onRemove:a,onChange:t=>m(t)},"multi_select_category_with_comparisons")]})};var d,v,S;i.parameters={...i.parameters,docs:{...(d=i.parameters)==null?void 0:d.docs,source:{originalSource:`({
  showComparisons,
  limit
...
}`,...(_=(h=l.parameters)==null?void 0:h.docs)==null?void 0:_.source}}};const M=["Playground","KitchenSink"],B=Object.freeze(Object.defineProperty({__proto__:null,KitchenSink:l,Playground:i,__namedExportsOrder:M,default:x},Symbol.toStringTag,{value:"Module"}));export{i as P,B as s};
