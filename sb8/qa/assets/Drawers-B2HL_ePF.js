import{r as i,R as g}from"./index-D0AnReJb.js";import{s as p,c as u}from"./styled-components.browser.esm-C5LJ_neh.js";import{t as f}from"./testIds-DLbO0bd9.js";import{D as v}from"./toNumber-CqnDHfZM.js";import{B as k}from"./Popper-D9JYON0d.js";function A(t,e){if(t.length===0)return[];const r=t[t.length-1];return t.map((n,s)=>{const o=s===t.length-1,l=s===t.length-2;return o&&n===!1&&e?"closing":o&&n===!0&&e?"opening":o&&n===!0?"open":l&&r===!0&&e?"stacking":l&&r===!1&&e?"unstacking":"stacked"})}const c=250,E=u`
	from {
	  	right: -75vw;
	}
	to {
