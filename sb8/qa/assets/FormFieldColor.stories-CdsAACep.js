import{j as e}from"./jsx-runtime-nGUw9YhZ.js";import{r as b}from"./index-BP8_t0zE.js";import{u as f,F as h}from"./formUtils-B3FmNo4o.js";import"./Button-BrUhf9jf.js";import{r as g}from"./renderButtons-BmHfsf_z.js";const S={title:"FormFields/FormFieldColor"},r=({label:n,required:t,skeleton:s,disabled:o})=>{const a=f(),{state:y,handleSubmit:F}=a,x=b.useMemo(()=>[{name:"color",label:n,type:"color",required:t,disabled:o}],[n,t,o]);return e.jsxs(e.Fragment,{children:[e.jsx("pre",{children:JSON.stringify(y,null,"  ")}),e.jsx("div",{style:{height:"100vh"},children:e.jsx(h,{...a,buttons:g(F),title:"Color Field",fields:x,skeleton:s})})]})};r.args={label:"Label",disabled:!1,required:!1,skeleton:!1};r.argTypes={label:{name:"Label"},disabled:{name:"Disabled"},required:{name:"Required"},skeleton:{name:"Skeleton"}};const l=()=>{const n=f(),{state:t,handleSubmit:s}=n,o=b.useMemo(()=>[{name:"color",label:"Regular Example",type:"color",required:!1,disabled:!1},{name:"colorDisabled",label:"Disabled Example",type:"color",required:!1,disabled:!0}],[]);return e.jsxs(e.Fragment,{children:[e.jsx("pre",{children:JSON.stringify(t,null,"  ")}),e.jsx("div",{style:{height:"100vh"},children:e.jsx(h,{...n,buttons:g(s),title:"Form Title",description:"This is a description example",fields:o})})]})};var i,d,c;r.parameters={...r.parameters,docs:{...(i=r.parameters)==null?void 0:i.docs,source:{originalSource:`({
  label,
  required,
  skeleton,
  disabled
...
}`,...(p=(u=l.parameters)==null?void 0:u.docs)==null?void 0:p.source}}};const j=["Playground","KitchenSink"],O=Object.freeze(Object.defineProperty({__proto__:null,KitchenSink:l,Playground:r,__namedExportsOrder:j,default:S},Symbol.toStringTag,{value:"Module"}));export{O as s};
