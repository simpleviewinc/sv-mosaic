import{j as e}from"./jsx-runtime-DKBipoO1.js";import{r as y}from"./index-P8U4y8pz.js";import{u as T,F}from"./Form-BRiCKpcY.js";import{r as g}from"./renderButtons-BmHfsf_z.js";const k={title:"FormFields/FormFieldPhone"},t=({label:r,required:o,skeleton:l,disabled:s,instructionText:a,helperText:i,autoFormat:u,country:d})=>{const c=T(),{state:S,handleSubmit:q}=c,j=y.useMemo(()=>[{name:"phone",label:r,type:"phone",required:o,disabled:s,inputSettings:{autoFormat:u,country:d},helperText:i,instructionText:a}],[s,o,u,d,r,i,a]);return e.jsxs(e.Fragment,{children:[e.jsx("pre",{children:JSON.stringify(S,null,"  ")}),e.jsx(F,{...c,buttons:g(q),title:"Phone Field",fields:j,skeleton:l})]})};t.args={label:"Label",disabled:!1,required:!1,skeleton:!1,instructionText:"Instruction text",helperText:"Helper text",autoFormat:!0,country:""};t.argTypes={label:{name:"Label"},disabled:{name:"Disabled"},required:{name:"Required"},skeleton:{name:"Skeleton"},instructionText:{name:"Instruction Text"},helperText:{name:"Helper Text"},autoFormat:{name:"Autoformat"},country:{name:"Country"}};const n=()=>{const r=T(),{state:o,handleSubmit:l}=r,s=y.useMemo(()=>[{name:"phone",label:"Regular example",type:"phone",required:!1,disabled:!1,helperText:"Helper text",instructionText:'Default contry code is "us"'},{name:"countryCode",label:"With a country code provided",type:"phone",required:!1,disabled:!1,inputSettings:{country:"ar"},helperText:"Helper text",instructionText:'The country code of "ar" was provided'},{name:"autoformatEnabled",label:"Autoformat enabled",type:"phone",required:!1,disabled:!1,inputSettings:{autoFormat:!0,country:"us"},helperText:"Helper text",instructionText:"Type a phone number to see the format"}],[]);return e.jsxs(e.Fragment,{children:[e.jsx("pre",{children:JSON.stringify(o,null,"  ")}),e.jsx(F,{...r,buttons:g(l),title:"Form Title",description:"Form description",fields:s})]})};var p,m,f;t.parameters={...t.parameters,docs:{...(p=t.parameters)==null?void 0:p.docs,source:{originalSource:`({
  label,
  required,
  skeleton,
  disabled,
...
}`,...(f=(m=t.parameters)==null?void 0:m.docs)==null?void 0:f.source}}};var h,x,b;n.parameters={...n.parameters,docs:{...(h=n.parameters)==null?void 0:h.docs,source:{originalSource:`(): ReactElement => {
  const controller = useForm();
  const {
    state,
    handleSubmit
...
}`,...(b=(x=n.parameters)==null?void 0:x.docs)==null?void 0:b.source}}};const H=["Playground","KitchenSink"],R=Object.freeze(Object.defineProperty({__proto__:null,KitchenSink:n,Playground:t,__namedExportsOrder:H,default:k},Symbol.toStringTag,{value:"Module"}));export{R as s};
