...
`,Mo=n=>{const{action:o,autoHideDuration:r=4e3,label:a,leadingIcon:i,onClose:p,open:g=!1}=n,m=i;let c=r;return r<4e3?c=4e3:r>1e4&&(c=1e4),s.jsx(ko,{autoHideDuration:c,onClose:p,open:g,anchorOrigin:{vertical:"bottom",horizontal:"right"},role:"alert",children:s.jsxs(vo,{children:[i&&s.jsx(m,{"data-testid":"leading-snackbar-icon"}),s.jsxs(So,{children:[s.jsx("p",{children:a}),(o==null?void 0:o.function)&&(o==null?void 0:o.label)&&s.jsx(wo,{children:s.jsx(eo,{color:"teal",variant:"text",onClick:o.function,label:o.label,muiAttrs:{disableRipple:!0}})})]}),s.jsx(ro,{"aria-label":"Close","data-testid":"close-icon",disableRipple:!0,onClick:p,size:"large",children:s.jsx(yo,{})},"close")]})})},Io=h.memo(Mo);export{Io as S};
