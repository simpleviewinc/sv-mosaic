...
`;function bc(e){const t=c.useCallback(function(a){e.onLimitChange({limit:Number(a)})},[e.onLimitChange]),n=c.useMemo(function(){return e.options.map(a=>({label:a.toString(),value:a.toString()}))},[e.options]),r=d.jsx(qt,{options:n,onChange:t,value:e.limit.toString()});return d.jsx(vc,{color:"black",label:e.limit.toString(),variant:"text",size:"small",iconPosition:"right",mIcon:Lt,mIconColor:M.newColors.almostBlack[100],menuContent:r})}const wc=c.memo(bc),xc=E.div`
	font-size: 14px;
	display: inline-flex;
	align-items: center;
...
`,Dc=E.span`
	font-weight: 400;
`;function pc(e){const{t}=Pe(),n=Math.ceil(e.count/e.limit),r=(e.skip+e.limit)/e.limit,a=e.skip+1,i=Math.min(e.skip+e.limit,e.count),o=u=>()=>{e.onSkipChange({skip:u})},s=r===1,l=r===n;return n===0?null:d.jsxs(kc,{children:[d.jsx(F,{color:"black",variant:"text",size:"small",tooltip:t("mosaic:DataView.jump_to_page"),label:d.jsxs("span",{children:[a,"-",i," ",d.jsx(Dc,{children:"of"})," ",e.count]}),popover:d.jsx(yc,{currentPage:r,totalPages:n,limit:e.limit,onSkipChange:e.onSkipChange})}),d.jsx(zn,{color:"gray",variant:"icon",size:"small",mIcon:ga,onClick:o(e.skip-e.limit),disabled:s}),d.jsx(zn,{color:"gray",variant:"icon",size:"small",mIcon:wa,onClick:o(e.skip+e.limit),disabled:l})]})}const Sc=c.memo(pc),Tc=E.div`
	align-items: center;
	display: flex;
	justify-content: space-between;
`,Rc=E.div`
...
`,Yc=E.div`
  ...
  width: 80px;
`,vu=E(da)`
`,bu=e=>{const{disabled:t,color:n,onClick:r,displayColorPicker:a,id:i}=e;return d.jsx(Uc,{$disabled:t,$displayColorPicker:a,onClick:r,type:"button",id:i,children:d.jsx(Yc,{"data-testid":"colordiv-test",$disabled:t,$color:n})})};export{Bt as A,bu as C,ic as D,vu as P,Bi as _,mu as a,Sa as b,ji as c,De as d,Ma as e,gu as f,za as g,kt as h,Hn as i,gt as j,La as k,Pa as l,hu as m,Va as n,Aa as o,Si as p,Ha as q,Y as r,mt as s,ce as t,Tn as u,Ya as v,j as w,Ra as x,ql as y,Wt as z};
