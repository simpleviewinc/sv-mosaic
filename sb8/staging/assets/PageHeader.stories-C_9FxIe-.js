import{j as l}from"./jsx-runtime-D_zvdyIk.js";import{P as c}from"./PageHeader-CVwaxNeh.js";import{o as n}from"./renderButtons-DP0bGf4C.js";import"./index-CDlOlYQx.js";const d={title:"Components/PageHeader"},e=({title:r,showButtons:s,showBack:i})=>l.jsx(c,{title:r,buttons:s?[{label:"Cancel",onClick:n,intent:"secondary",variant:"contained"},{label:"Save",onClick:()=>alert("Saving"),intent:"primary",variant:"contained"}]:void 0,onBack:i?n:void 0});e.args={title:"Playground page",showButtons:!0,showBack:!0};e.argTypes={title:{name:"Title"},showButtons:{name:"Show Primary Actions"},showBack:{name:"Show Back Button"}};var t,a,o;e.parameters={...e.parameters,docs:{...(t=e.parameters)==null?void 0:t.docs,source:{originalSource:`({
  title,
  showButtons,
  showBack
