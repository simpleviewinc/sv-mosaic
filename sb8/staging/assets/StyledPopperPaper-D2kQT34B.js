...
`;var i={},s;function f(){if(s)return i;s=1;var o=p();Object.defineProperty(i,"__esModule",{value:!0}),i.default=void 0;var t=o(l()),a=c();return i.default=(0,t.default)((0,a.jsx)("path",{d:"M11 7h2v2h-2zm0 4h2v6h-2zm1-9C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2m0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8"}),"InfoOutlined"),i}var g=f();const h=d(g),R=r(h)`
  && {
...
`,q=r(u).attrs({popperOptions:{modifiers:[{name:"offset",options:{offset:[0,parseInt(e.spacing(2),10)]}}]}})`
	z-index: 1300;
...
`,M=r.li.attrs(o=>({...o,className:`${o.className||""} Mos-listboxOption`}))``,z=r(m)(({$hideShadow:o,$hideBorder:t})=>{const a=[!t&&"var(--mos-border-light)",!o&&"0 34px 60px 0 rgba(0, 0, 0, 0.15)",!o&&"var(--mos-shadow-xl)"].filter(Boolean).join(",");return`
		border-radius: ${e.rounded.md};
		box-shadow: ${a||"0 0"};
	`}),j=r(x)`
	border-radius: ${e.rounded.md};
	box-shadow:
		...
		var(--mos-shadow-xl);
`;export{k as C,S as F,b as R,q as S,R as T,z as a,C as b,M as c,j as d};
