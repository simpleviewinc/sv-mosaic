...
`,r.jsx(o.pre,{children:r.jsx(o.code,{className:"language-js",children:`import { transform_colorPicker } from "#mosaic"
...
transforms : [
    transform_colorPicker()
]
`})})]})}function ur(i={}){const{wrapper:o}={...m(),...i.components};return o?r.jsx(o,{...i,children:r.jsx(t,{...i})}):t(i)}export{ur as default};
