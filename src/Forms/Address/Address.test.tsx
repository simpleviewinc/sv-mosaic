...
describe('Address component', () => {
	it('should add a new address card', () => {
		const { queryAllByTestId } = render(<Address fieldDef={{ name: 'fieldTest', label: 'Address label' }} />);
	...
	it('should edit an address card', () => {
		const { getByText, getByLabelText, getAllByTestId, getAllByRole } = render(<Address fieldDef={{ name: 'fieldTest', label: 'Address label' }} />);
