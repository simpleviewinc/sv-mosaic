...
* **fields** - `FieldDef[]` required - Array of fields containing their respective configuration (see Generic Field Props subsection).
...
* **dispatch** - `any` required - Function in charge of updating the state (see Dispatch Actions subsection).
...
* **cancelButtonAttrs** - `ButtonAttrs` optional - Additional attributes to change styling and/or functionality of the cancel button (see ButtonAttrs type).
* **submitButtonAttrs** - `ButtonAttrs` optional - Additional attributes to change styling and/or functionality of the save button (see ButtonAttrs type).
...
* **onSubmit** - `(...args: any) => any` optional - Function that will be executed when the user clicks on the save button of the form.
