...
const App = (props) => {
	...
	// If you want to create a section and included into the 
	// Form check how is done in the Layout - Sections section
	// and pass it through the section prop of the Form component.
...
* **size** - `Sizes | string` optional - Size of the field. Could be either one of the predefined sizes, or a custom size. This property can be internally overwritten if the field is placed inside of a row with other fields.
	* **xs** = 100px
	* **sm** = 280px
	* **md** = 450px
	* **lg** = 620px
