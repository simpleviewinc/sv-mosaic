...
function DataViewKitchenSink(): ReactElement {
	...
	const comparisonDefault: string = select("comparisonDefault", { "Equals": "equals", "Not Equals": "not_equals", "Contains": "contains", "Not Contains": "not_contains", "Exists": "exists", "Not Exists": "not_exists" }, "contains");
