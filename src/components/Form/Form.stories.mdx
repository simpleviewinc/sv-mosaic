...
| `isLatitude` | | _Latitude should be between -90 and 90_ | Validates a value is a number between -90 and 90. |
| `isLongitude` | | _Longitude should be between -180 and 180_ | Validates a value is a number between -180 and 180. |
