...
* **maxCharacters** - `number` optional - When defined, displays the max amount of characters allowed for this field next to the label (only applies for Text field).
...
| **`maxRows`** | `string `\|` number` | optional - Maximum number of rows to display when multiline options is set to true. |
...
| Name | Type | Description |
| ---- | ---- | ----------- |
| **`amountPerType`** | `number` | Optional - Limits the types of addresses that can be selected. |
| **`amountShipping`** | `number` | Optional - Limits the shipping addresses that can be added. |
| **`amountBilling`** | `number` | Optional - Limits the billing addresses that can be added. |
| **`amountPhysical`** | `number` | Optional - Limits the physical addresses that can be added. |
