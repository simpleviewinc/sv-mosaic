...
* **buttons** - `ButtonAttrs` optional - Array of buttons that will be rendered at the TopComponent. Each button object can be configured based on the button's props (see [ButtonAttrs type](#buttonattrs-type)).
...
- This hook returns a state, a dispatcher, and a registerFields which will be explained in the following subsections.
