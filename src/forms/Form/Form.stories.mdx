...
- inputSettings: `object`
	...
	* **amountShipping** - `number` optional - When defined, limits the amount of address types to "shipping" only. Takes precedence over amountPerType.
	* **amountPhysical** - `number` optional - When defined, limits the amount of address types to "physical" only. Takes precedence over amountPerType.
	* **amountBilling** - `number` optional - When defined, limits the amount of address types to "billing" only. Takes precedence over amountPerType.
